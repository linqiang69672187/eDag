// 夜狼制作 OFFICE风格的色彩选择器
//注意:只有把script /script标签放在 body 标签内才可以正常使用“其它颜色”功能
...
function colordialog() {
    ...
    ocolorPopup.show(offsetGet(e, true) + 14, offsetGet(e, false) - 8, 158, 147, document.body);
}