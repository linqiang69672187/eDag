...
function MapMonitoringEvent(inputMap){
    ...
    //设置图层图片缩放尺度
    this.setScaleChange = function (layerID, ids, layer, scaleRate) {
                    ...
                    if (style) {
                        ...
                        if (text) {
                            if (!text.isFirstLoad) {
                                ...
                                text.firstScale = text.getScale() / scaleRate;
                                text.firstOffsetY = text.getOffsetY() / scaleRate;
                            } else {
                                var scale = text.firstScale * scaleRate;
                                text.setScale(scale);
    ...
    try{
        ...
        cMap.getView().on('change:resolution', function (event) {
            ...
            layers.forEach(function (value) {
                ...
                setScaleChange(layerID, idArray, value, scaleRate);
            })
