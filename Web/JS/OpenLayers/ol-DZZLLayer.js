...
function fillcolorjs(Color) {
    if (Color == "#000000") {
        fillColorDZZL = 'rgba(0, 0, 0, 0.3)'
    } else if (Color == "#ff0033") {
        fillColorDZZL = 'rgba(255, 0, 0, 0.3)'
    } else if (Color == "#33FF33") {
        fillColorDZZL = 'rgba(0, 139, 0, 0.3)'
    } else if (Color == "#0000FF") {
        fillColorDZZL = 'rgba(30,144, 255, 0.3)'
    }
}
function addInteraction(id, fillcolor, strokecolor, type, mytitle, opacity) {
    ...
    var Fillcolor = fillcolorjs(fillcolor)
    var styles = {
