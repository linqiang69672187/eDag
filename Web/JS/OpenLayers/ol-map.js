...
var cameraLayerManager, heatMapManager;//cameraLayerManager:摄像头图层管理器;heatMapManager:热力图管理图层
...
//cxy-20180730-获取地图图层
function getLayerById(thismap, id) {
    var currenMap = thismap;
    var layers = thismap.getLayers();
