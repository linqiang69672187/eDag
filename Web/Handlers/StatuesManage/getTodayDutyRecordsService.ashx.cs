...
{
    /// <summary>
    /// getTodayDutyRecordsService 的摘要说明
    /// </summary>
    public class getTodayDutyRecordsService : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataTable dt = drdService.getTodayDutyRecords(int.Parse(strProID), entitid, Start, End);
            DataTable dt2 = drdService.getTodayDutyRecordsCount(int.Parse(strProID), entitid);
