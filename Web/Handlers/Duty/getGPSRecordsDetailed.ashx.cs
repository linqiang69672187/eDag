...
{
    /// <summary>
    /// getGPSRecordsDetailed 的摘要说明
    /// </summary>
    public class getGPSRecordsDetailed : IHttpHandler
    {
        ...
        {
            //PageIndex: currentPage, Limit: everypagecount,entity:entity,status:status_m,begtime:begtime_m
            //endtime:endtime_m ,userissi:userissi_m}
            ...
            DataTable dt = gpsReportDao.getGPSRecordsOfDetailed(begtime, endtime, accessUnitIdList, usertypes, status, userissi, Start, End, condition);
            DataTable dt2 = gpsReportDao.getGPSRecordsOfDetailedCount(begtime, endtime, accessUnitIdList, usertypes, status, userissi, Start, End, condition);
