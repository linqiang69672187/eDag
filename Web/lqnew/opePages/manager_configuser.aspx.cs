...
{
    public partial class manager_configuser : System.Web.UI.Page
    {
        public string loginusername = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            loginusername = Request.Cookies["username"].Value.Trim();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                System.Web.UI.HtmlControls.HtmlInputText html = (System.Web.UI.HtmlControls.HtmlInputText)e.Row.FindControl("txtUserName");
                if (loginusername != "root" && html.Value.Trim() == "root")
                {
                    e.Row.Visible = false;
                }
            ...
            switch (e.CommandName)
            {
                case "MyDel":
                    ...
                    if (err == "")
                    {
                        ...
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>window.document.getElementById('Lang_AddNew').src = window.parent.GetTextByName('Lang_AddNew', window.parent.useprameters.languagedata);alert('" + ResourceManager.GetString("OperationSuccessful") + "');window.parent.lq_changeifr('manager_configuser');</script>");
                    }
