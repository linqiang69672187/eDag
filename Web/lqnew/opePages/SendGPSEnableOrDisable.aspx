<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  CodeBehind="SendGPSEnableOrDisable.aspx.cs"
    Inherits="Web.lqnew.opePages.SendGPSEnableOrDisable" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var Lang_GPSOpenISDoing = window.parent.parent.GetTextByName("Lang_GPSOpenISDoing", window.parent.parent.useprameters.languagedata);
        ...
        function addMemberToSelectUsers() {
            ...
            for (var i = 0; i < SelectUsers.length; i++) {
                if (SelectUsers[i].uissi == issi) {//防止重复添加
        ...
        function CloseWindow() {
            ...
            window.parent.mycallfunction('SendGPSEnableOrDisable');
        }
        
        $(document).ready(function () {
            if (window.parent.isSendingGPSEnableOrDisable) {
                alert(Lang_GPSOpenISDoing);
                CloseWindow();
                return;
            }
        ...
        function OnAddMember() {
            window.parent.mycallfunction('AddMemberTree/add_Member', 650, 514, '0&ifr=SendGPSEnableOrDisable_ifr&selectcount=-1&type=user', 2001);//type：all显示全部；user表示只显示user；
        }
        function faterdo(retrunissis) {
            ...
            //SelectUsers = eval(retrunissis);//直接删除时会出错
        ...
        function disableGPS() {
            ...
            window.parent.sendGPSEnableOrDisable(SelectUsers, 0);
        ...
        function enableGPS() {
            ...
            window.parent.sendGPSEnableOrDisable(SelectUsers, 1);
            alert(Lang_SendZLIsSendingPleaseSeeSysLogWindow);
            CloseWindow();
        }
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul">
                                        <li>
                                            <img alt="" src="../images/037.gif" /><span id="Lang_GPSEnableOrDisable"><%--遥启遥毙--%></span></li>
                                    </ul>
                                </td>
                                          ...
                                          <input type="text" id="txtISSIText" runat="server" /><input onclick="addMemberToSelectUsers()" type="button" id="aLang-Add" value="添加" />
                                           ...
                                           <table style="width:400px; border-top:solid;border-top-color:mediumseagreen;border-top-width:1px">
                                               ...
                                               <tr class="gridheadcss">
                                                   <th align="center"  style="width:70px;background-color:ActiveBorder"><span style="cursor:pointer" id="Lang_Name">名称</span></th>
                                                   <th align="center"  style="width:70px;background-color:ActiveBorder"><span style="cursor:pointer" id="Lang_ISSS">终端号码</span></th>
                                                   <th align="center"  style="width:70px;background-color:ActiveBorder"><span style="cursor:pointer" id="Lang_style">用户类型</span></th>
                                                   <th align="center"  style="width:90px;background-color:ActiveBorder"><span style="cursor:pointer" id="Lang_ISSItype">终端类型</span></th>
                                        ...
                                        <td class="style3" align="center" colspan="3">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="CALLBUTTON1" id="Single_Open" style="text-align: center; cursor: pointer;"
                                                            onclick="enableGPS()">
                                                            <%--开启--%></button>
                                                    </td>
                                                </tr>
...
<script type="text/javascript">
    ...
    window.document.getElementById("Closebtn").innerHTML = window.parent.parent.GetTextByName("Closebtn", window.parent.parent.useprameters.languagedata);

    window.document.getElementById("Single_Open").innerHTML = window.parent.parent.GetTextByName("Single_Open", window.parent.parent.useprameters.languagedata);
