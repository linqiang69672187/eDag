<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddGroupCallMember.group_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var biangroup = window.parent.parent.parent.GetTextByName("Group", window.parent.parent.parent.useprameters.languagedata);
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(biangroup) };
