...
{
    public partial class ISSI_tree : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            DbComponent.Tree myissitree = new DbComponent.Tree(Request.Cookies["id"].Value, new string[] { ResourceManager.GetString("Terminal") }, ResourceManager.GetString("Terminal"), Request.Cookies["username"].Value);
