...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function checkInfo() {
            ...
            if (window.document.getElementById("openSwitch").checked) {
                ...
                window.document.getElementById("sendDestISSI").value = "16777213";
                window.document.getElementById("distanceNum").value = "0";
                window.document.getElementById("PullUpCycle").value = "0";
                document.getElementById("PullUpCount").value = "0";
        ...
        function SendPullUPContralRequest() {
            if (!checkInfo()) {
                ...
                if (window.document.getElementById("openSwitch").checked == true) {
                    totleCycle = PullUpCount_textChange();
                }
       ...
       // var IsPullUpCycle = false;
        ...
        function PullUpCount_textChange() {
            ...
            //if (IsPullUpCycle) {
                ...
                if (totleCycle!=0 &&(totleCycle < 180 || totleCycle > 33554432)) {
                    alert(window.parent.parent.GetTextByName("Lang_PullExpireCheck", window.parent.parent.useprameters.languagedata));
                    return null;
                }
                if (cycle > 16384) {
                    alert(window.parent.parent.GetTextByName("Lang_PullPeriodCheck", window.parent.parent.useprameters.languagedata));
                    return null;
                }

                if ((totleCycle>0)&&(totleCycle < cycle)) {
        ...
        function dragdiv() {
            ...
            //将event.button的值由1改为0----------------------xzj--2018/7/11-----------------------------------------------------
        ...
        function OnPullupClose() {
            if (window.document.getElementById("closeSwitch").checked == true) {
                window.document.getElementById("distanceNum").value = "0";
                window.document.getElementById("PullUpCycle").value = "0";
                document.getElementById("PullUpCount").value = "0";
                window.document.getElementById("distanceNum").disabled = true;
                window.document.getElementById("PullUpCycle").disabled = true;
                document.getElementById("PullUpCount").disabled = true;
            }
            else {
                window.document.getElementById("distanceNum").value = "0";
                window.document.getElementById("PullUpCycle").value = "";
                document.getElementById("PullUpCount").value = "";
                window.document.getElementById("distanceNum").disabled = false;
                window.document.getElementById("PullUpCycle").disabled = false;
                document.getElementById("PullUpCount").disabled = false;
            }
        }
    </script>
</head>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left" colspan="2">
                                       <%-- <asp:RadioButton Text="已激活" ID="openSwitch" runat="server" Checked="true"/>
                                        ...
                                        <input type="radio" id="openSwitch" name="switch" checked="checked" onclick="OnPullupClose();" /><span id="Lang_Open"></span>&nbsp;&nbsp;
                                        <input type="radio" id="closeSwitch" name="switch" onclick="OnPullupClose();" /><span id="sssssssss"></span>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                    ...
                                    <td align="left" colspan="2">
                                        <input style="float:left;" type="text" value="" id="PullUpCount"  runat="server"/><span style="display:block; float:left;">S&nbsp;&nbsp;</span><span id="show_effectCircle" style="color:red;word-break:normal;display:block;width:295px; float:left; vertical-align:top;"></span><span id="span_PullUpCount" style="color: red; display:block;float:left;"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="left" colspan="2">
                                        <input type="text" id="PullUpCycle" />S&nbsp;&nbsp;<span style="color: red;word-break:normal;width:295px;" id="explain_PullUpCycle">* 10秒的倍数</span>&nbsp;&nbsp;<span id="span_PullUpCycle" style="color: red"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="left" colspan="2">
                                        <select id="distanceNum" style="width:80px;"> 
                                            ...
                                            <option value ="9">700</option>  
                                            <option value ="10">1000</option>  
                                            <option value="11">1300</option>   
                                            <option value="12">1700</option>
                                            <option value ="13">2200</option>  
                                            <option value ="14">2800</option>  
...
<script type="text/javascript">
    ...
    document.getElementById("distanceNum").options[0].text = window.parent.parent.GetTextByName("Lang_PullDistanceNotSet", window.parent.parent.useprameters.languagedata);
