<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit_login.aspx.cs"
    Inherits="Web.lqnew.opePages.edit_login" %>
                                    ...
                                    <table class="style1" cellspacing="1" id="dragtd">
                                            ...
                                            <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png); height: 33;">
                                                <div style="background-image: url(../images/add_entity_info.png); width: 109px; height: 23px;">
                                                    <div style="margin-left: 30px; font-size: 14px; font-weight: bold; color: #006633; padding-top: 5px;">
                                                        <span class="Langtxt" id="Dispatcher"></span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style3" align="right" style="width: 90px;">
                                                <span class="Langtxt" id="Lang_Role"></span>&nbsp;&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Style="display: none;"
                                        ...
                                        <tr>
                                            <td class="style3" align="right">
                                                <span class="Langtxt" id="Lang_voiceType"></span>&nbsp;&nbsp;
                                            </td>
                                            <td align="left">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtCheckPwd" runat="server" Width="100px" TextMode="Password"></asp:TextBox>
                                                    <font color="red">*</font>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCheckPwd"
                                                        Display="None"></asp:RequiredFieldValidator>
                                                ...
                                                <OnHide>
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtCheckPwd"
                                                        ControlToCompare="TextBox2" Display="None"></asp:CompareValidator>
