<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit_DXGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.edit_DXGroup" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table class="style1" cellspacing="1" id="dragtd">
                                            ...
                                            <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png); height: 33;">
                                                <div style="background-image: url(../images/add_entity_info.png); width: 109px; height: 23px;">
                                                    <div style="margin-left: 29px; font-size: 14px; font-weight: bold; color: #006633; padding-top: 5px;">
                                                        <span class="Langtxt" id="DXgroupinformation"></span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="style3" align="left">
                                                ...
                                                <asp:RequiredFieldValidator ValidationGroup="vgsumit" ID="RequiredFieldValidator1"
                                                    runat="server" ControlToValidate="TextBox1" Display="None"></asp:RequiredFieldValidator>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td background="images/tab_05.gif">
                                                                                <ul class="hor_ul">
                                                                                    ...
                                                                                    <li>
                                                                                        <asp:ImageButton ID="ImageButton6" runat="server" OnClick="ImageButton6_Click" /></li>
                                                                                </ul>
                                                                            </td>
                                                                            <td width="14">
                            ...
                            <tr>
                                ...
                                <td align="center" height="30">
                                    <asp:ImageButton ID="ImageButton1" ValidationGroup="vgsumit" ImageUrl=""
