<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="add_TBGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.add_TBGroup" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../js/add_list.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        function init() {
            this.parent.$("#add_TBGroup").height(800);
            this.parent.$("#add_TBGroup_ifr").height(800);
        }
        //终端类型选择
    ...
    function checkTellRule() {
        ...
        //至少选择一个成员组
        if ($("#<% =hidSelGssisValue.ClientID %>").val() == "0") {
            alert(window.parent.GetTextByName("AtLeastOneMember", window.parent.useprameters.languagedata));
            result = false;
            return result;
        }
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="281" background="../images/tab_05.gif" align="right">
                                    <img style="cursor: hand;" onclick="window.parent.mycallfunction('add_TBGroup')"
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center">
                                    <table class="style1" cellspacing="1" id="dragtd">
                                        ...
                                        <tr>
                                            <td class="style3" align="right" style="width: 85px;">
                                        ...
                                        <tr>
                                            <td class="style3" align="right">
                                                <span class="Langtxt" id="TBgroupbzt"></span>&nbsp;&nbsp;
                                            </td>
                                            <td class="style3" align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">&nbsp;<asp:CheckBox ID="chkExternal" runat="server" /></td>
                                        </tr>
                                        <tr>
                                            <td class="style3" align="right">
                                            ...
                                            <td align="left">
                                                <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" DataSourceID="ObjectDataSource2"
                                                    DataTextField="name" Width="120px" DataValueField="id">
                                                </asp:DropDownList>
                                                                            ...
                                                                            <td bgcolor="#f3ffe3">
                                                                                ...
                                                                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" SortParameterName="sort"
                                                                                    ...
                                                                                    <SelectParameters>
                                                                                        ...
                                                                                        <asp:QueryStringParameter Name="GSSI" DefaultValue="0" />
                                                                                        <asp:CookieParameter CookieName="id" Name="id" Type="Int32" />
                                                                                    </SelectParameters>
                                                                                </asp:ObjectDataSource>
                                                                            </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td background="images/tab_21.gif">
                                                                                <asp:Label ID="Label1" runat="server" OnLoad="Label1_Load"><img src="../images/viewinfo_bg.png" /><span class="Langtxt" id="MMembersgroup" ></span>…</asp:Label>
                                                                                <asp:DropDownList ID="DropDownList5" runat="server" Height="16px" Visible="False">
                                                                                    <asp:ListItem Value="0"></asp:ListItem>
                                                                                </asp:DropDownList><asp:HiddenField ID="hidSelGssisValue" runat="server" Value="0" />
                                                                            </td>
                                                                            <td width="14">
                            ...
                            <tr>
                                ...
                                <img id="Lang-Cancel" style="cursor: pointer;" onclick="window.parent.mycallfunction('add_TBGroup')" />
                                <!---------------------------xzj--2018/6/28--将imgid改为id,cursor属性值改为pointer------------------>
                                </td>
                                <td width="14" background="../images/tab_16.gif">&nbsp;
                                </td>
