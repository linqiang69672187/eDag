...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var Active_Fail_to_active = window.parent.parent.GetTextByName("Active_Fail_to_active", window.parent.parent.useprameters.languagedata);
        var Active_Gateway_response_success = window.parent.parent.GetTextByName("Active_Gateway_response_success", window.parent.parent.useprameters.languagedata);
        var Active_Terminal_response_success = window.parent.parent.GetTextByName("Active_Terminal_response_success", window.parent.parent.useprameters.languagedata);
        var Active_Terminal_response_timeout = window.parent.parent.GetTextByName("Active_Terminal_response_timeout", window.parent.parent.useprameters.languagedata);
        var Unactive_Gateway_response_timeout = window.parent.parent.GetTextByName("Unactive_Gateway_response_timeout", window.parent.parent.useprameters.languagedata);
        var Unactive_response_fail = window.parent.parent.GetTextByName("Unactive_response_fail", window.parent.parent.useprameters.languagedata);
        var Unactive_response_success = window.parent.parent.GetTextByName("Unactive_response_success", window.parent.parent.useprameters.languagedata);
        var Not_operate = window.parent.parent.GetTextByName("Not_operate", window.parent.parent.useprameters.languagedata);
        var invalid = window.parent.parent.GetTextByName("invalid", window.parent.parent.useprameters.languagedata);
        var Pulling = window.parent.parent.GetTextByName("Pulling", window.parent.parent.useprameters.languagedata);
            ...
            window.parent.jquerygetNewData_ajax("../../Handlers/GetGPSPullStatusList.ashx", { begtime: begtime, endtime: endtime, PageIndex: currentPage, Limit: everypagecount, selentity: selentityid, selwhere: selissiorname, selfun: selfun, selStatues: selStatues }, function (msg) {
                ...
                for (var i = 0; i < msg.data.length; i++) {
                    ...
                    switch (msg.data[i].Result) {
                        case "0":
                            PUResult = Active_Fail_to_active //"激活失败";
                            break;
                        case "1":
                            PUResult = Active_Gateway_response_success;//"处理中，网关响应成功";
                            break;
                        case "2":
                            PUResult = Active_Terminal_response_success;//"成功，终端响应成功";
                            break;
                        case "3":
                            PUResult = Active_Terminal_response_timeout;//"激活网关响应超时";
                            break;
                        case "4":
                            PUResult = Unactive_Gateway_response_timeout;//"去激活网关响应超时";
                            break;
                        case "5":
                            PUResult = Unactive_response_fail;//"失败，去激活响应失败";
                            break;
                        case "6":
                            PUResult = Unactive_response_success;//"成功，去激活响应成功";
                            break;
                        case "100":
                            PUResult = Not_operate ;//"未操作";
                            break;
                        default:
                            PUResult = invalid;//"非法";
                            break;
                    ...
                    switch (msg.data[i].PullStatus) {
                        case "0":
                            PUStatus = Not_operate;//"未操作";
                            break;
                        case "1":
                            PUStatus = Pulling;//"正在上拉";
                            break;
                        default:
                            PUStatus = invalid; //"非法";
                            break;
        ...
        function GPSEnableOrDisplay(sid) {
            window.parent.visiablebg2();//虞晨超20170930 修复连续点击时网页报错
            ...
            if (window.parent.document.getElementById('circleLocation'))//20181119--xzj
            {
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center" valign="top" style="height: 351px; background-color: white" id="dragtd">
