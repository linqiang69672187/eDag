<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_FixedStation.aspx.cs" Inherits="Web.lqnew.opePages.add_FixedStation" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../images/tab_05.gif">
                                <ul class="hor_ul">
                                    <li>
                                        <img src="../images/037.gif" /><span class="Langtxt" id="add" ></span></li>
                                </ul>
                            </td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table class="style1" cellspacing="1" id="dragtd">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="style3">
                                            <asp:TextBox ID="txtFSISSI" runat="server" Width="150px"></asp:TextBox><font
                                                color="red">*</font>
                                            <asp:RequiredFieldValidator ID="rfvFSISSI" runat="server" ControlToValidate="txtFSISSI"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="style3">
                                            ...
                                            <font color="red">*</font>
                                            <asp:RequiredFieldValidator ID="rfvFSGSSIS" runat="server" ControlToValidate="txtFSGSSIS"
                                                      Display="None"></asp:RequiredFieldValidator>
                                        </td>
                                  </tr>
                                     <tr>
                                    ...
                                    <tr>
                                        <td class="style3" align="right" style="width: 100px;">
                                            <span class="Langtxt" id="Longitude" ></span>：
                                        </td>
                                        <td align="left" class="style3">
                                    ...
                                    <tr>
                                        <td class="style3" align="right" style="width: 100px;">
                                            <span class="Langtxt" id="Latitude" ></span>：
                                        </td>
                                        <td align="left" class="style3">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <img class="style4" style="cursor: hand;" onclick="window.parent.CloseJWD();window.parent.mycallfunction(geturl())"
                                     imgid="Lang-Cancel"  />
                            </td>
                            <td width="14" background="../images/tab_16.gif">
                                &nbsp;
