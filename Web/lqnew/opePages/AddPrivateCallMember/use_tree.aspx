<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="use_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPrivateCallMember.use_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var police = window.parent.parent.parent.GetTextByName("police", window.parent.parent.parent.useprameters.languagedata);//"警员"
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(police) };//"警员"
