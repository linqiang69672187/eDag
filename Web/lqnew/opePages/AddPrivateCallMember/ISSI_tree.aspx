<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ISSI_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPrivateCallMember.ISSI_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var Terminal = window.parent.parent.parent.GetTextByName("Terminal", window.parent.parent.parent.useprameters.languagedata);//终端
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(Terminal) }; //"终端"
