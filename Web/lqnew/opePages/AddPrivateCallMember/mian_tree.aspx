<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mian_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPrivateCallMember.mian_tree" %>
    ...
    <form id="form1" style="height: 425;" runat="server">
        <div style="height: 425;">
            ...
            <ul class="tabs" style="margin: 0px; display: none;" id="tabsid">
                ...
                <li id="liDispatch"><a href="#"><span id="Lang_Dispatch"><%--调度台--%></span></a></li>
...
<script>
    ...
    window.onload = function () {
        ...
        tab.style.display = "";
        if (window.parent.Request.QueryString("ifr") == "EnableDisableRadio_ifr") {
            document.getElementById("liDispatch").style.display = "none";
            document.getElementById("divDispatch").style.display = "none";
        }
    }
</script>
</html>
