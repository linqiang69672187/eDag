<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_Member.aspx.cs" Inherits="Web.lqnew.opePages.AddPrivateCallMember.add_Member" %>
...
.style2{width: 10px;}
.bg1{background-image:url('../../view_infoimg/images/bg_02.png');background-repeat:repeat-x;vertical-align:top;}
.bg2{background-image:url('../../view_infoimg/images/bg_10.png');background-repeat:repeat-x;}
.bg3{background-image:url('../../view_infoimg/images/bg_05.png');background-repeat:repeat-y;}
.bg4{background-image:url('../../view_infoimg/images/bg_06.png');}
.bg5{background-image:url('../../view_infoimg/images/bg_07.png');background-repeat:repeat-y;}
...
.gridheadcss th{background-image:url(../images/tab_14.gif);height:25px;}
#GridView1{ margin-top:3px; font-size:12px;}
.td1td{background-color:#FFFFFF;text-align:right;}
.divgrd{margin:2 0 2 0;overflow:auto;height:365px;}
 #tags{ width: 99px;}
.style3{width: 37px;}
...
//            switch (Request.QueryString("ifr")) {
//                case "Send_SMS_ifr":
//                    document.getElementById("smstree").src = "mian_tree.aspx";
//                    break;
//                case "Send_StatusMS_ifr":
//                    document.getElementById("smstree").src = "mian_tree.aspx";
//                    break;
//                case "PrivateCall_ifr":
//                    document.getElementById("smstree").src = "mian_tree.aspx";
//                    break;
//                default: break;
//            }
        ...
        function sendok() {
            ...
            if (sendMsgwindo) {
                ...
                window.parent.lq_closeANDremovediv('AddPrivateCallMember/add_Member', 'bgDiv');
            }
        }
        var dragEnable = 'True';
        function dragdiv() {
            var div1 = window.parent.document.getElementById('AddPrivateCallMember/add_Member');
...
<body>
    ...
    <table class="style1" cellpadding="0" cellspacing="0">
        <tr style="height:5px;">
            <td class="style2"><img src="../../view_infoimg/images/bg_01.png" /></td>
            <td class="bg1"><div id="divClose" style="display:none" onmouseover="Divover('on')" onclick="window.parent.lq_closeANDremovediv('AddPrivateCallMember/add_Member','bgDiv')" onmouseout="Divover('out')"></div></td>
            <td class="style2"><img src="../../view_infoimg/images/bg_04.png" /></td>
        </tr>
        <tr>
            <td class="bg3">&nbsp;
                </td>
            <td class="bg4"  id="dragtd">
                <table cellpadding="0" cellspacing="0" class="style3">
                    <tr>
                        <td><table  id="tb1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"  cellspacing="1" width="190px">
                    <tr>
                        <td align="left" class="td1td"><table width="190px" border="0" cellspacing="3">
                          <tr>
                            <td align="left"><iframe name="smstree" src="mian_tree.aspx" width="190px"   allowTransparency="true" style="padding-top:0px"  frameborder="0"  height="425px" scrolling="no" ></iframe></td>
                          </tr>
                        </table>
                       </td>
                    </tr>
            ...
            <td>
                ...
                <br />
                &nbsp;</td>
            <td><table  id="Table1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"  cellspacing="1" width="200px">
                    <tr>
                        <td align="left" class="td1td"><table width="400px" border="0" cellspacing="3">
                          <tr>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td background="../images/tab_12.gif" width="9">
                                                    &nbsp;</td>
                                                <td bgcolor="#f3ffe3">
    ...
    <tr class="gridheadcss" style="font-weight:bold;font-size:12px;">
			<th scope="col" id="Unit" ><%--单位--%></th><th scope="col" style="white-space:nowrap;width:40px;" id="Type"><%--类型--%></th><th scope="col" style="white-space:nowrap;width:60px;">
            ISSI/GSSI</th><th scope="col" style="white-space:nowrap;width:60px;" id="Username"><%--姓名--%></th><th scope="col" width="20px">&nbsp;</th>
		</tr>
        <tbody id="GridView1">	
       </tbody>
      </table>
                                                ...
                                                <td background="../images/tab_16.gif" width="9">
                                                    &nbsp;</td>
                                            </tr>
                                        </table>
                                    </td>
               ...
               <tr>
                 ...
                 <td colspan="3" align="left" height="35px">
                     <img id="add_okPNG" style="margin-top:3px;cursor:pointer;display:none" src="<%--../../images/edit_entity.png--%>"  onclick="sendok()" />&nbsp;
                     <img id="cancelbutton" style="margin-top:3px;cursor:pointer;display:none" src="<%--../../images/add_cancel.png--%>" onclick="window.parent.lq_closeANDremovediv('AddPrivateCallMember/add_Member','bgDiv')" /></td>
              </tr>
                </table>
        ...
        <tr style="height:5px;">
            <td><img src="../../view_infoimg/images/bg_09.png" /></td>
              <td class="bg2"></td>
            <td><img src="../../view_infoimg/images/bg_11.png" /></td>
        </tr>
    </table>
    </form>
</body>  
...
<script>
    ...
    //alert("wwwwwwwwwwwwww" + window.document.getElementById("Unit").innerHTML);
</script>