<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_PJgroup.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_PJgroup" %>
...
<body>
    ...
    <table class="style1" cellpadding="0" cellspacing="0">
        <tr style="height: 5px;">
            ...
            <td class="bg1">
                <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_PJgroup')"
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_PJgroup');
    ...
    window.parent.lq_changeheight('view_info/view_PJgroup', document.body.clientHeight);
    window.parent.change('view_info/view_PJgroup');
