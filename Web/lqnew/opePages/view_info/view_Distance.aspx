<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_Distance.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_Distance" %>
...
<script type="text/javascript">
    ...
    function view(type) {
        window.parent.parent.parent.mycallfunction('view_info/view_ExplainDistance', 450, 600,0, 2014);
        var num = 0;
        var viewDistanceInterval = setInterval(function () {
            if (window.parent.parent.parent.document.frames["view_info/view_ExplainDistance_ifr"] != null && window.parent.parent.parent.document.frames["view_info/view_ExplainDistance_ifr"] != undefined && (typeof window.parent.parent.parent.parent.document.frames["view_info/view_ExplainDistance_ifr"].toHTML).toString() != "undefined") {
                window.parent.parent.parent.document.frames["view_info/view_ExplainDistance_ifr"].toHTML(type, false);
                clearInterval(viewDistanceInterval);
            } else {
                if (num >= 5) { clearInterval(viewDistanceInterval); }
                else { num++; }
            }
        }, 1000);
    }
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.parent.parent.document.getElementById("view_info/view_Distance");
        ...
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1" colspan="2" onmousemove=" mydragWindow()" onmouseup="mystopDragWindow()" onmousedown="dragdiv()">
                    <div id="divClose" onclick="window.parent.parent.parent.parent.mycallfunction('view_info/view_Distance')">
                    </div>
                </td>
                <td class="style2">
