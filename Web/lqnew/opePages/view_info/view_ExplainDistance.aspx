<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_ExplainDistance.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_ExplainDistance" %>
...
<body>
        ...
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1" colspan="2" onmousemove=" mydragWindow()" onmouseup="mystopDragWindow()" onmousedown="dragdiv()">
                    <div id="divClose" onclick="window.parent.parent.parent.parent.mycallfunction('view_info/view_ExplainDistance')">
                    </div>
                </td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd" colspan="2">
                    <table id="Table1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                        cellspacing="1" width="100%">
                        <tr>
                            <td colspan="2" class="td1td" style="text-align: center">
                                <span id="setValue" style="color: blue; width:auto"></span>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 60%; text-align: center;background-color: #FFFFFF;font-weight: bold;height:25px;" >
                                <span id="Lang_Value_Range"></span>
                                <span id="Span1" class="Langtxt">(x)</span>
                            </td>
                            <td style="width: 40%; text-align: center;background-color: #FFFFFF;font-weight: bold;height:25px;">
    ...
    <script type="text/javascript">
        ...
        function toHTML(ISSI_Type, IsCycle) {
            ...
            if (IsCycle) {
                ...
                if (ISSI_Type == "TETRA" || ISSI_Type == "BEIDOU") {
                    ...
                    document.getElementById("tab").style.height = 520;
                    //document.getElementById("tab").innerHTML = strResult;
                } else {
        ...
        var dragEnable = 'True';
        function dragdiv() {
            var div1 = window.parent.parent.document.getElementById("view_info/view_ExplainDistance");
        ...
        function mydragWindow() {
            var div1 = window.parent.parent.parent.document.getElementById("view_info/view_ExplainDistance");
            if (div1) {
