<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewpage.aspx.cs" Inherits="Web.lqnew.opePages.view_info.viewpage" %>
...
<body>
    <table class="style1" cellpadding="0" cellspacing="0">
        <tr style="height: 5px;">
            ...
            <td class="bg1">
                <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/viewpage')" onmouseout="Divover('out')"></div>
            </td>
            <td class="style2">
                ...
                <table id="tb1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                    ...
                    <tr>
                        <td align="left" class="td1td">
                            <span id="Lang_EntityName" class="Langtxt" ></span>&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="left" class="td1td">
                            <span id="Lang_ParentEntity" class="Langtxt" >上级单位</span>&nbsp;&nbsp;
                        </td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td">
                            <span id="Lang_EntityDepth" class="Langtxt" >单位层级</span>&nbsp;&nbsp;
                        </td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td">
                            <span id="Lang_Remark" class="Langtxt" >备注</span>&nbsp;&nbsp;
                        </td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                </table>
...
<script>
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/viewpage');
    ...
    window.parent.lq_changeheight('view_info/viewpage', document.body.clientHeight); window.parent.change('view_info/viewpage');</script>
</html>
