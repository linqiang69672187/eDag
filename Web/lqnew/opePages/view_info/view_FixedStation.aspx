<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_FixedStation.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_FixedStation" %>
...
<body>
    <form id="form1" runat="server">
        <table id="sum" class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                <td class="style2">
                    <img alt="" src="../../view_infoimg/images/bg_01.png" /></td>
                <td class="bg1">
                    <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_FixedStation')" onmouseout="Divover('out')"></div>
                </td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd">
                    <table id="tab" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                        cellspacing="1" width="100%">
                        <tr>
                            <td align="left" class="Langtxt" id="GDTBZ">:</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="Langtxt" id="Subordinateunits">:</td>
                            <td align="left" style="cursor: pointer;" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="Langtxt" id="zhuliuzu">:</td>
                            <td align="left" style="cursor: pointer;" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="Langtxt" id="Longitude">:</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="Langtxt" id="Latitude">:</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                    </table>
                </td>
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_FixedStation');
    ...
    window.parent.lq_changeheight('view_info/view_FixedStation', document.body.clientHeight);
    window.parent.change('view_info/view_FixedStation');
