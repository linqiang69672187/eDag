<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_Stackade.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_Stackade" %>
...
<body>
    <table class="style1" cellpadding="0" cellspacing="0">
        <tr style="height: 5px;">
            ...
            <td class="bg1">
                <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_Stackade')" onmouseout="Divover('out')"></div>
            </td>
            <td class="style2">
        ...
        <tr>
            ...
            <td class="bg4" id="dragtd">
                <table id="tb1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                    ...
                    <tr>
                        <td align="left" class="td1td"><span class="Langtxt" id="creater"><%--创建者--%></span>&nbsp;&nbsp;</td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td"><span class="Langtxt" id="Name"><%--名称--%></span>&nbsp;&nbsp;</td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td"><span class="Langtxt" id="createtime"><%--创建时间--%></span>&nbsp;&nbsp;</td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td"><span class="Langtxt" id="StockType"><%--栅栏类型--%></span>&nbsp;&nbsp;</td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" class="td1td"><span class="Langtxt" id="Identification"><%--标识--%></span>&nbsp;&nbsp;</td>
                        <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr>
                </table>
            </td>
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_Stackade');
    ...
    window.parent.lq_changeheight('view_info/view_Stackade', document.body.clientHeight);
    window.parent.change('view_info/view_Stackade');
