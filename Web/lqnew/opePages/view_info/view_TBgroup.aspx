<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_TBgroup.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_TBgroup" %>
    ...
    <form id="form1" runat="server">
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1">
                    <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_TBgroup')"
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_TBgroup');
    ...
    window.parent.lq_changeheight('view_info/view_TBgroup', document.body.clientHeight);
    window.parent.change('view_info/view_TBgroup');
