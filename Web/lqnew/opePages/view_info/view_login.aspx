<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_login.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_login" %>
    ...
    <form id="form1" runat="server">
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1">
                    <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_login')" onmouseout="Divover('out')"></div>
                </td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd">
                    <table id="tb1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td align="left" class="tablecs"><%--用户名--%>
                                <span id="Lang_usename" class="Langtxt"></span>&nbsp;&nbsp;
                            </td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="tablecs"><%--密码--%>
                                <span id="Lang_PWD" class="Langtxt"></span>&nbsp;&nbsp;
                            </td>
                            <td align="left" style="cursor: pointer;" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="tablecs"><%--单位--%>
                                <span id="Lang_Unit" class="Langtxt"></span>&nbsp;&nbsp;
                            </td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="tablecs"><%--单位--%>
                                <span id="Lang_voiceType" class="Langtxt"></span>&nbsp;&nbsp;
                            </td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_login');
    ...
    window.parent.lq_changeheight('view_info/view_login', document.body.clientHeight);
    window.parent.change('view_info/view_login');
