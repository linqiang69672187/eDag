<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_group.aspx.cs" Inherits="Web.lqnew.opePages.view_info.view_group" %>
    ...
    <form id="form1" runat="server">
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1">
                    <div id="divClose" onmouseover="Divover('on')" onclick="window.parent.mycallfunction('view_info/view_group')" onmouseout="Divover('out')"></div>
                </td>
                <td class="style2">
                    ...
                    <table id="tb1" align="center" bgcolor="#c0de98" runat="server" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td align="left" class="td1td">
                                ...
                                <span class="Langtxt" id="GroupName"></span>&nbsp;&nbsp;</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="td1td">

                                <span class="Langtxt" id="TypeName"></span>&nbsp;&nbsp;</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="td1td">

                                <span class="Langtxt" id="Unit"></span>&nbsp;&nbsp;</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="td1td">

                                <span class="Langtxt" id="groupbz"></span>&nbsp;&nbsp;</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" class="td1td"> 
                                <span class="Langtxt" id="external_system"></span>&nbsp;&nbsp;</td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                        <tr style="display: none">
                            <td align="left" class="td1td"></td>
                            <td align="left" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                    </table>
                </td>
...
<script type="text/javascript">
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('view_info/view_group');
    ...
    window.parent.lq_changeheight('view_info/view_group', document.body.clientHeight);
    window.parent.change('view_info/view_group');
