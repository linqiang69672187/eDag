<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false" CodeBehind="add_user.aspx.cs" Inherits="Web.lqnew.opePages.add_user" %>
                                ...
                                <table class="style1" cellspacing="1" id="dragtd">
                                        ...
                                        <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png);
                                            ...
                                            <div style="background-image: url(../images/add_entity_info.png); width: 132px; height: 23px;">
                                                <div style="margin-left: 28px; font-size: 14px; font-weight: bold; color: #006633;
                                                    padding-top: 5px;">
                                                    <span class="Langtxt" id="yidongyonghu" ></span></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style3" align="right" style="width: 90px;">
                                            <span class="Langtxt" id="Lang_Type" ></span>&nbsp;&nbsp;
                                        </td>
                                        <td class="style3" align="left">
                                            <asp:DropDownList ID="DropDownList2" runat="server" Width="120px" AppendDataBoundItems="True"
                                                DataSourceID="ODSType" DataTextField="TypeName" DataValueField="id">
                                            </asp:DropDownList>
                                            <asp:ObjectDataSource ID="ODSType" runat="server" SelectMethod="GetAllUserType" TypeName="DbComponent.UserTypeDao">
                                                <SelectParameters>
                                                </SelectParameters>
                                    ...
                                    <tr>
                                        <td class="style3" align="right">
                                            <span class="Langtxt" id="Lang_SubordinateunitsBelong" ></span>&nbsp;&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        <td class="style3" align="right">
                                            <span class="Langtxt" id="Lang_name" ></span>&nbsp;&nbsp;
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td class="style3" align="right">
                                            <span class="Langtxt" id="Lang_Serialnumber" ></span>&nbsp;&nbsp;
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="okw" Text="" runat="server" Width="120px"></asp:TextBox>
