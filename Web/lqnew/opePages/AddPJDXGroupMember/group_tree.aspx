<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPJDXGroupMember.group_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var group = window.parent.parent.GetTextByName('Lang_Group', window.parent.parent.useprameters.languagedata);
        //var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent("编组") };
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(group) };
