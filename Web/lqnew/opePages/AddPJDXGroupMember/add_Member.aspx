<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_Member.aspx.cs" Inherits="Web.lqnew.opePages.AddPJDXGroupMember.add_Member" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function sendok() {
            ...
            var retrunissis = [];
            var UnkownUser = window.parent.parent.GetTextByName("UnkownUser", window.dialogArguments.useprameters.languagedata);
            for (var i = 0; i < tbl.rows.length; i++) {


                if (tbl.rows[i].cells[3].innerHTML == "未知" || tbl.rows[i].cells[3].innerHTML == "") {
                    //retrunissis.push({ gname: '未知用户', gissi: tbl.rows[i].cells[2].innerHTML });
                    retrunissis.push({ gname: UnkownUser, gissi: tbl.rows[i].cells[2].innerHTML });
                } else {
                    retrunissis.push({ gname: tbl.rows[i].cells[3].innerHTML, gissi: tbl.rows[i].cells[2].innerHTML });
                }
            }

            var ifr = Request.QueryString("ifr")
            var Lang_number_group_cannot_null = window.parent.parent.GetTextByName("Lang_number_group_cannot_null", window.dialogArguments.useprameters.languagedata);
            ...
            if (sendMsgwindo) {
                ...
                window.parent.lq_closeANDremovediv('AddPJDXGroupMember/add_Member', 'bgDiv');
            }
        }
        var dragEnable = 'True';
        function dragdiv() {
            var div1 = window.parent.document.getElementById('AddPJDXGroupMember/add_Member');
    ...
    <form id="form1" runat="server">
        ...
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1">
                    <div id="divClose" style="display: none" onmouseover="Divover('on')" onclick="window.parent.lq_closeANDremovediv('AddPJDXGroupMember/add_Member','bgDiv')" onmouseout="Divover('out')"></div>
                </td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd">
                    <table cellpadding="0" cellspacing="0" class="style3">
                     ...
                     <img id="cancelbutton" style="margin-top: 3px; cursor: hand; display: none" src="<%--../../images/add_cancel.png--%>" onclick="window.parent.lq_closeANDremovediv('AddPJDXGroupMember/add_Member','bgDiv')" /></td>
                        </tr>
                    </table>
