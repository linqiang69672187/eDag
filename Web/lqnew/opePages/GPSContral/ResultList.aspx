<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultList.aspx.cs" Inherits="Web.lqnew.opePages.GPSContral.ResultList" %>
                        ...
                        <table cellspacing="1" cellpadding="0" id="GridView1" style="border-color: White; border-width: 0px; border-style: Ridge; width: 390px; font-size: 12px">
                            <tr class="gridheadcss" style="width: 390px; height: 10px">
                                <td>
                                    ...
                                    <span id="span_ok" style="background-color: green; width: 0px; height: 8px"></span>
                                    <span id="span_un" style="background-color: yellow; width: 200px; height: 8px"></span>
                                </td>
...
<script>
 ...
 <script type="text/javascript">
    ...
    document.getElementById("qxzx").value = window.parent.GetTextByName("LangBtnToCancelDoing", window.parent.useprameters.languagedata);
     ...
     var Lang_GPS_Open_Success = window.parent.GetTextByName("Lang_GPS_Open_Success", window.parent.useprameters.languagedata);
     var Lang_GPS_Close_Success = window.parent.GetTextByName("Lang_GPS_Close_Success", window.parent.useprameters.languagedata);
     var Lang_GPS_Para_Success = window.parent.GetTextByName("Lang_GPS_Para_Success", window.parent.useprameters.languagedata);
     var Lang_GPS_Open_Failed = window.parent.GetTextByName("Lang_GPS_Open_Failed", window.parent.useprameters.languagedata);
     var Lang_GPS_Close_Failed = window.parent.GetTextByName("Lang_GPS_Close_Failed", window.parent.useprameters.languagedata);
     var Lang_GPS_Para_Failed = window.parent.GetTextByName("Lang_GPS_Para_Failed", window.parent.useprameters.languagedata);
     var Lang_GPS_mode_Success = window.parent.GetTextByName("Lang_GPS_mode_Success", window.parent.useprameters.languagedata);
     var Lang_GPS_mode_Failed = window.parent.GetTextByName("Lang_GPS_mode_Failed", window.parent.useprameters.languagedata);
     var Lang_GPS_Open_Unknow = window.parent.GetTextByName("Lang_GPS_Open_Unknow", window.parent.useprameters.languagedata);
     var Lang_GPS_Close_Unknow = window.parent.GetTextByName("Lang_GPS_Close_Unknow", window.parent.useprameters.languagedata);
     var Lang_GPS_Para_Unknow = window.parent.GetTextByName("Lang_GPS_Para_Unknow", window.parent.useprameters.languagedata);
     var Lang_GPS_mode_Unknow = window.parent.GetTextByName("Lang_GPS_mode_Unknow", window.parent.useprameters.languagedata);

     var Lang_GPS_switch_Num = window.parent.GetTextByName("GPS_Switch_Num", window.parent.useprameters.languagedata);
     var Lang_GPS_distance_Success = window.parent.GetTextByName("Lang_GPS_distance_Success", window.parent.useprameters.languagedata);
     var Lang_GPS_distance_Failed = window.parent.GetTextByName("Lang_GPS_distance_Failed", window.parent.useprameters.languagedata);
     var Lang_GPS_distance_Unknow = window.parent.GetTextByName("Lang_GPS_distance_Unknown", window.parent.useprameters.languagedata);
     ...
     function CancalDo() {
         ...
         window.parent.clear_gpscontral_run();
         document.getElementById("resultContent").innerHTML += "<br>" + LangYouHaveCancel;
         document.getElementById("qxzx").style.display = "none";
     }

     function toHTML(totalcount, havedocount, openorClose, openCount, cgOpenArrary, sbOpenArrary, modifyCount, modify_cgArrary, modify_sbArrary, modelCount, model_cgArrary, model_sbArrary, distanceCount, distance_cgArrary, distance_sbArrary) {
         var cg_Open = cgOpenArrary.length;
         var sb_Open = sbOpenArrary.length;
         var cg_modify = modify_cgArrary.length;
         var sb_modify = modify_sbArrary.length;
         var cg_model = model_cgArrary.length;
         var sb_model = model_sbArrary.length;
         var cg_distance = distance_cgArrary.length;
         var sb_distance = distance_sbArrary.length;
         var strtitle = "";
         var wcgs = "";
         var otherstr = "";
         ...
         var wzarraycount = openCount - parseFloat(cg_Open) - parseFloat(sb_Open);//开关操作未知个数=需要设置个数-成功-失败
         var wz_modifyCount = modifyCount - parseFloat(cg_modify) - parseFloat(sb_modify);//参数设置未知个数=需要设置个数-成功-失败
         var wz_modelCount = modelCount - parseFloat(cg_model) - parseFloat(sb_model);//模式设置未知个数=需要设置个数-成功-失败
         var wz_distanceCount = distanceCount - parseFloat(cg_distance) - parseFloat(sb_distance);//距离上报设置未知个数=需要设置个数-成功-失败
         ...
         if (parseInt(openCount) > 0) {
             if (openorClose == "1") {
                 otherstr += "<br>" + Lang_GPS_Open_Success + ":" + cg_Open;
                 otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_Open) / parseFloat(openCount))) * 100) + "%";

                 otherstr += "<br>" + Lang_GPS_Open_Failed + ":<span id='span_sb'>" + sb_Open + "</span>";
                 otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_Open) / parseFloat(openCount))) * 100) + "%";

                 otherstr += "<br>" + Lang_GPS_Open_Unknow + ":" + wzarraycount;
                 otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wzarraycount) / parseFloat(openCount))) * 100) + "%";
             } else {
                 otherstr += "<br>" + Lang_GPS_Close_Success + ":" + cg_Open;
                 otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_Open) / parseFloat(openCount))) * 100) + "%";

                 otherstr += "<br>" + Lang_GPS_Close_Failed + ":<span id='span_sb'>" + sb_Open + "</span>";
                 otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_Open) / parseFloat(openCount))) * 100) + "%";

                 otherstr += "<br>" + Lang_GPS_Close_Unknow + ":" + wzarraycount;
                 otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wzarraycount) / parseFloat(openCount))) * 100) + "%";
             }
         }

         if (parseInt(modifyCount) > 0) {
             otherstr += "<br>" + Lang_GPS_Para_Success + ":" + cg_modify;
             otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_modify) / parseFloat(modifyCount))) * 100) + "%";

             otherstr += "<br>" + Lang_GPS_Para_Failed + ":<span id='span_sb_modify'>" + sb_modify + "</span>";
             otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_modify) / parseFloat(modifyCount))) * 100) + "%";

             otherstr += "<br>" + Lang_GPS_Para_Unknow + ":" + wz_modifyCount;
             otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wz_modifyCount) / parseFloat(modifyCount))) * 100) + "%";
         }

         //if (parseInt(modelCount) > 0) {
         //    otherstr += "<br>" + Lang_GPS_mode_Success + ":" + cg_model;
         //    otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_model) / parseFloat(modelCount))) * 100) + "%";

         //    otherstr += "<br>" + Lang_GPS_mode_Failed + ":<span id='span_sb_model'>" + sb_model + "</span>";
         //    otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_model) / parseFloat(modelCount))) * 100) + "%";

         //    otherstr += "<br>" + Lang_GPS_mode_Unknow + ":" + wz_modelCount;
         //    otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wz_modelCount) / parseFloat(modelCount))) * 100) + "%";
         //}

         if (parseInt(distanceCount) > 0) {
             otherstr += "<br>" + Lang_GPS_distance_Success + ":" + cg_distance;
             otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_distance) / parseFloat(distanceCount))) * 100) + "%";

             otherstr += "<br>" + Lang_GPS_distance_Failed + ":<span id='span_sb_distance'>" + sb_distance + "</span>";
             otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_distance) / parseFloat(distanceCount))) * 100) + "%";

             otherstr += "<br>" + Lang_GPS_distance_Unknow + ":" + wz_distanceCount;
             otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wz_distanceCount) / parseFloat(distanceCount))) * 100) + "%";
         }
     ...
     //function toHTMLOld(totalcount, havedocount, openorclose, cjarry, sbarry, modify_cgarrary, modify_sbarrary, model_cgarrary, model_sbarrary) {
     ...
     //    var wz_modifyCount = totalcount - parseFloat(cg_modify) - parseFloat(sb_modify);//参数设置未知个数=总数量-成功-失败
     //    var wz_modelCount = totalcount - parseFloat(cg_model) - parseFloat(sb_model);//模式设置未知个数=总数量-成功-失败
     ...
     //    } else {
     //        otherstr += "<br>" + Lang_GPS_Close_Success + ":" + cjcount;
     //        otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cjcount) / parseFloat(totalcount))) * 100) + "%";

     //        otherstr += "<br>" + Lang_GPS_Close_Failed + ":<span id='span_sb'>" + sbcount + "</span>";
     //        otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sbcount) / parseFloat(totalcount))) * 100) + "%";
     ...
     //    otherstr += "<br>" + Lang_GPS_Para_Success + ":" + cg_modify;
     //    otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_modify) / parseFloat(totalcount))) * 100) + "%";

     //    otherstr += "<br>" + Lang_GPS_Para_Failed + ":<span id='span_sb_modify'>" + sb_modify + "</span>";
     //    otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_modify) / parseFloat(totalcount))) * 100) + "%";

     //    otherstr += "<br>" + Lang_GPS_Para_Unknow + ":" + wz_modifyCount;
     //    otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wz_modifyCount) / parseFloat(totalcount))) * 100) + "%";

     //    otherstr += "<br>" + Lang_GPS_mode_Success + ":" + cg_model;
     //    otherstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cg_model) / parseFloat(totalcount))) * 100) + "%";

     //    otherstr += "<br>" + Lang_GPS_mode_Failed + ":<span id='span_sb_model'>" + sb_model + "</span>";
     //    otherstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sb_model) / parseFloat(totalcount))) * 100) + "%";

     //    otherstr += "<br>" + Lang_GPS_mode_Unknow + ":" + wz_modelCount;
     //    otherstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wz_modelCount) / parseFloat(totalcount))) * 100) + "%";
     ...
     window.onload = function () {
         ...
         document.onmousedown = function () {
             var div1 = window.parent.document.getElementById('GPSContral/ResultList');
     ...
     function closethispage() {
         ...
         window.parent.lq_closeANDremovediv('GPSContral/ResultList', 'bgDiv');
     }
