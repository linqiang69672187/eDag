<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="add_BSGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.add_BSGroup" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="281" background="../images/tab_05.gif" align="right">
                                <img style="cursor: hand;" onclick="window.parent.mycallfunction('add_BSGroup')"
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png);
                                            ...
                                            <div style="background-image: url('../images/add_entity_info.png'); width: 130px; height: 23px;">
                                                <div style="margin-left: 27px; font-size: 14px; font-weight: bold; color: #006633;
                                                    padding-top: 5px;">
                                                    <span class="Langtxt" id="JZgroupinformation" ></span></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style3" align="right" style="width: 75px;">
                                            <span class="Langtxt" id="Stationgroupname" ></span>&nbsp;&nbsp;
                                        </td>
                                        <td class="style3" align="left">
                                            <asp:TextBox ID="TextBox1" ValidationGroup="sub1" runat="server" Width="135px"></asp:TextBox>
                                            <font color="red">*</font>
                        ...
                        <tr>
                            ...
                            <td align="center" height="30">
                                ...
                                <img  id="Lang-Cancel"   style="cursor: pointer;" onclick="window.parent.mycallfunction('add_BSGroup')"
                                   />
                                 <!---------------------------xzj--2018/6/28--将imgid改为id,cursor属性值改为pointer------------------>
                            </td>
                            <td width="14" background="../images/tab_16.gif">
