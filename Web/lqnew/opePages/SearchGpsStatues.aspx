<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchGpsStatues.aspx.cs" Inherits="Web.lqnew.opePages.SearchGpsStatues" %>
   ...
   <script src="../js/GlobalConst.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function getData() {
            ...
            $("#Tbody1").append("<tr id='isprocessing' style='background-color:White;height:22px;color:red'><td colspan='8' >" + Lang_loading + "</td></tr>");
            window.parent.jquerygetNewData_ajax("../../Handlers/GetGPSStatusList.ashx", { begtime: begtime, endtime: endtime, PageIndex: currentPage, Limit: everypagecount, selentity: selentityid, selwhere: selissiorname, selfun: selfun, selStatues: selStatues }, function (msg) {
                $("#isprocessing").remove();
                ...
                if (msg.data.length == 0) {
                    $("#Tbody1").append("<tr id='isprocessing' style='background-color:White;height:22px;color:red; '><td colspan='8' >" + LangNone + "</td></tr>");
                }
                var gpsopendisplay = "";
                var gpsparamdisplay = "";
                var gpscritical = "";
                var gpsmodedisplay = "";
                var gpsdistancedisplay = "";
                if (document.getElementById("selFunc").value == '-1') {
                    showAllColumns();
                    gpsopendisplay = " display:table-cell; ";
                    gpsparamdisplay = " display:table-cell; ";
                    gpscritical = " display:table-cell; ";
                    gpsmodedisplay = " display:table-cell; ";
                    gpsdistancedisplay = " display:table-cell; ";
                } else if (document.getElementById("selFunc").value == '1') {
                    onlyGPSOpen();
                    gpsopendisplay = " display:table-cell; ";
                    gpsparamdisplay = " display:none; ";
                    gpscritical = " display:none; ";
                    gpsmodedisplay = " display:none; ";
                    gpsdistancedisplay = " display:none; ";
                } else if (document.getElementById("selFunc").value == '0') {
                    onlyGPSParam();
                    gpsopendisplay = " display:none; ";
                    gpsparamdisplay = " display:table-cell; ";
                    gpscritical = " display:none; ";
                    gpsmodedisplay = " display:none; ";
                    gpsdistancedisplay = " display:none; ";
                } else if (document.getElementById("selFunc").value == '2') {
                    onlyGPSCritical();
                    gpsopendisplay = " display:none; ";
                    gpsparamdisplay = " display:none; ";
                    gpscritical = " display:table-cell; ";
                ...
                //else if (document.getElementById("selFunc").value == '3') {
                //    onlyGPSMode();
                //    gpsopendisplay = " display:none;";
                //    gpsparamdisplay = " display:none;";
                //    gpscritical = " display:none;";
                //    gpsmodedisplay = " display:inline;";
                //    gpsdistancedisplay = " display:none;";
                //}
                else if (document.getElementById("selFunc").value == '4') {
                    onlyGPSDistance();
                    gpsopendisplay = " display:none; ";
                    gpsparamdisplay = " display:none; ";
                    gpscritical = " display:none;";
                ...
                for (var i = 0; i < msg.data.length; i++) {
                    var gpsopen = msg.data[i].GPSOpen;
                    if (msg.data[i].GPSOpen == '-1') {
                        gpsopen = Undo;
                    }
                    var gpscricle = msg.data[i].GPSCircle + "(" + msg.data[i].CircleStatues1 + ")";
                    if (msg.data[i].GPSCircle == "-1") {
                        gpscricle = Undo;
                    }
                    var gpsdest = msg.data[i].GPSDestination + "(" + msg.data[i].DestinationStatues1 + ")";
                    if (msg.data[i].GPSDestination == "-1") {
                        gpsdest = Undo;
                    }
                    var gpsmode = msg.data[i].GPSorBEIDOU + "(" + msg.data[i].GPSorBEIDOUStatues1 + ")";
                    if (msg.data[i].GPSorBEIDOU == null || msg.data[i].GPSorBEIDOU == "-1") {
                        gpsmode = Undo;
                    } else if (msg.data[i].GPSorBEIDOU == "1") {
                        gpsmode = window.parent.parent.GetTextByName("BEIDOU", window.parent.parent.useprameters.languagedata) + "(" + msg.data[i].GPSorBEIDOUStatues1 + ")";
                    } else if (msg.data[i].GPSorBEIDOU == "3") {
                        gpsmode = "GPS" + "(" + msg.data[i].GPSorBEIDOUStatues1 + ")";
                    } else if (msg.data[i].GPSorBEIDOU == "7") {
                        gpsmode = window.parent.parent.GetTextByName("Lang_GPSandBEIDOU_Model", window.parent.parent.useprameters.languagedata) + "(" + msg.data[i].GPSorBEIDOUStatues1 + ")";
                    }
                    var gpsdistance = msg.data[i].GPSDistance + "(" + msg.data[i].GPSDistanceStatues1 + ")";
                    if (msg.data[i].GPSDistance == "-1") {
                        gpsdistance = Undo;
                    }
                    var strcheck = "";
                    ...
                    //<td style='" + gpsmodedisplay + "' align='center' >" + gpsmode + "</td>
                    if (msg.data[i].ipAddress != null && msg.data[i].ipAddress.toString().trim() != "" && msg.data[i].ipAddress != undefined && msg.data[i].ipAddress.toString().trim() != "0.0.0.0" && msg.data[i].ipAddress.toString().trim() != "0.0.0.0:0") {
                        $("#Tbody1").append("<tr id=" + msg.data[i].ISSI + " onmouseover='changeTgBg(this,&#39;font&#39;)' onmouseout='overchangeTgBg(this,&#39;font&#39;)' style='background-color:White;height:22px;'><td><input id='checkbox_" + msg.data[i].ISSI + "' type='checkbox' " + strcheck + " onclick='onclickCheckBoxp(this)' value='" + msg.data[i].id + "' /></td><td align='center' style='cursor: hand;' onmousedown='viewLTEStatues(" + msg.data[i].ISSI + ",\"" + msg.data[i].ipAddress + "\"," + true + ")' >" + msg.data[i].ISSI + "</td><td  align='center'>" + msg.data[i].nam + "</td><td  align='center'>" + msg.data[i].OperatorTime + "</td><td style='" + gpsopendisplay + "' align='center'>" + gpsopen + "</td><td style='" + gpscritical + "' align='center'>" + gpscricle + "</td><td style='" + gpsparamdisplay + "' align='center' >" + msg.data[i].ipAddress + "</td><td style='" + gpsdistancedisplay + "' align='center' >" + gpsdistance + "</td></tr>");
                    } else if (msg.data[i].GPSDestination == "") {
                        //<td style='" + gpsmodedisplay + "' align='center' >" + gpsmode + "</td>
                        $("#Tbody1").append("<tr id=" + msg.data[i].ISSI + " onmouseover='changeTgBg(this,&#39;font&#39;)' onmouseout='overchangeTgBg(this,&#39;font&#39;)' style='background-color:White;height:22px;'><td><input id='checkbox_" + msg.data[i].ISSI + "' type='checkbox' " + strcheck + " onclick='onclickCheckBoxp(this)' value='" + msg.data[i].id + "' /></td><td align='center'>" + msg.data[i].ISSI + "</td><td  align='center'>" + msg.data[i].nam + "</td><td  align='center'>" + msg.data[i].OperatorTime + "</td><td style='" + gpsopendisplay + "' align='center'>" + gpsopen + "</td><td style='" + gpscritical + "' align='center'>" + gpscricle + "</td><td style='" + gpsparamdisplay + "' align='center' >" + "" + "</td><td style='" + gpsdistancedisplay + "' align='center' >" + gpsdistance + "</td></tr>");
                    } else {
                        //<td style='" + gpsmodedisplay + "' align='center' >" + gpsmode + "</td>
                        $("#Tbody1").append("<tr id=" + msg.data[i].ISSI + " onmouseover='changeTgBg(this,&#39;font&#39;)' onmouseout='overchangeTgBg(this,&#39;font&#39;)' style='background-color:White;height:22px;'><td><input id='checkbox_" + msg.data[i].ISSI + "' type='checkbox' " + strcheck + " onclick='onclickCheckBoxp(this)' value='" + msg.data[i].id + "' /></td><td align='center'>" + msg.data[i].ISSI + "</td><td  align='center'>" + msg.data[i].nam + "</td><td  align='center'>" + msg.data[i].OperatorTime + "</td><td style='" + gpsopendisplay + "' align='center'>" + gpsopen + "</td><td style='" + gpscritical + "' align='center'>" + gpscricle + "</td><td style='" + gpsparamdisplay + "' align='center' >" + gpsdest + "</td><td style='" + gpsdistancedisplay + "' align='center' >" + gpsdistance + "</td></tr>");
                    }
                    arrayISSI.push(msg.data[i].ISSI);
                }
                tocheckall();
            });
        }
        ...
        function GPSEnableOrDisplay(sid) {
            window.parent.document.getElementById("SendGPSContral").value = sid;
        ...
        function GPSContral(sid) {
            window.parent.visiablebg2();//虞晨超20170930
        ...
        function onclickSelectAll(obj) {
            if (obj.checked) {
                ...
                for (var j = 0; j < dd.length; j++) {
                    ...
                    if (dd[j].type == "checkbox") {//20171103虞晨超删除 && !dd[j].checked GPS上拉按钮边上选择框 出现反选无法取消勾选的情况
                        dd[j].checked = false;
                    }
                }
            }
        ...
        function selfunOnChange() {
            if (document.getElementById("selFunc").value == '-1') {
                window.document.getElementById("listatues").style.display = "none";
            } else if (document.getElementById("selFunc").value == '1') {
                window.document.getElementById("opSuccess").text = Single_Open;
                window.document.getElementById("opFailed").text = Closebtn;
                window.document.getElementById("listatues").style.display = "inline";
            } else if (document.getElementById("selFunc").value == '0') {
                window.document.getElementById("opSuccess").text = Success;
                window.document.getElementById("opFailed").text = Failed;
                window.document.getElementById("listatues").style.display = "inline";
            } else if (document.getElementById("selFunc").value == '2') {
                window.document.getElementById("opSuccess").text = Success;
                window.document.getElementById("opFailed").text = Failed;
        ...
        function showAllColumns() {
            window.document.getElementById("Lang_GPSSwitch2").style.display = "table-cell";
            window.document.getElementById("Lang_GPSDest2").style.display = "table-cell";
            window.document.getElementById("tdcpscritical").style.display = "table-cell";

            //window.document.getElementById("Lang_GPS_Model").style.display = "table-cell";
            //window.document.getElementById("Lang_GPS_Model").style.width = "12%";
            window.document.getElementById("Lang_GPSSwitch2").style.width = "12%";
            window.document.getElementById("Lang_GPSDest2").style.width = "24%";
            window.document.getElementById("tdcpscritical").style.width = "12%";
            window.document.getElementById("Lang_GPS_Distance").style.width = "12%";
          
            window.document.getElementById("Lang_GPS_Distance").style.display = "table-cell";
        }
        function onlyGPSOpen() {
            window.document.getElementById("Lang_GPSSwitch2").style.display = "table-cell";
            window.document.getElementById("Lang_GPSDest2").style.display = "none";
            window.document.getElementById("tdcpscritical").style.display = "none";

            window.document.getElementById("Lang_GPSSwitch2").style.width = "60%";
            window.document.getElementById("Lang_GPSDest2").style.width = "0%";
            window.document.getElementById("tdcpscritical").style.width = "0%";
            //window.document.getElementById("Lang_GPS_Model").style.display = "none";
            //window.document.getElementById("Lang_GPS_Model").style.width = "0%";
            window.document.getElementById("Lang_GPS_Distance").style.display = "none";
            window.document.getElementById("Lang_GPS_Distance").style.width = "0%";
        }
        function onlyGPSParam() {
            window.document.getElementById("tdcpscritical").style.display = "none";
            window.document.getElementById("Lang_GPSSwitch2").style.display = "none";
            window.document.getElementById("Lang_GPSDest2").style.display = "table-cell";
            window.document.getElementById("Lang_GPSSwitch2").style.width = "0%";
            window.document.getElementById("Lang_GPSDest2").style.width = "60%";
            window.document.getElementById("tdcpscritical").style.width = "0%";
            //window.document.getElementById("Lang_GPS_Model").style.display = "none";
            //window.document.getElementById("Lang_GPS_Model").style.width = "0%";
            window.document.getElementById("Lang_GPS_Distance").style.display = "none";
        ...
        function onlyGPSCritical() {
            ...
            window.document.getElementById("Lang_GPSSwitch2").style.width = "0%";
            window.document.getElementById("Lang_GPSDest2").style.width = "0%";
            window.document.getElementById("tdcpscritical").style.width = "60%";
            window.document.getElementById("Lang_GPS_Distance").style.display = "none";
            window.document.getElementById("Lang_GPS_Distance").style.width = "0%";
        }
        function onlyGPSMode() {
            window.document.getElementById("tdcpscritical").style.display = "table-cell";
            window.document.getElementById("Lang_GPSSwitch2").style.display = "none";
            window.document.getElementById("Lang_GPSDest2").style.display = "none";
            window.document.getElementById("tdcpscritical").style.display = "none";
            ...
            window.document.getElementById("Lang_GPSDest2").style.width = "0%";
            window.document.getElementById("tdcpscritical").style.width = "0%";
            //window.document.getElementById("Lang_GPS_Model").style.width = "60%";
            window.document.getElementById("Lang_GPS_Distance").style.width = "0%";
        }
        function onlyGPSDistance() {
            window.document.getElementById("tdcpscritical").style.display = "table-cell";
            window.document.getElementById("Lang_GPSSwitch2").style.display = "none";
            window.document.getElementById("Lang_GPSDest2").style.display = "none";
            window.document.getElementById("tdcpscritical").style.display = "none";
           // window.document.getElementById("Lang_GPS_Model").style.display = "none";
            ...
            //window.document.getElementById("Lang_GPS_Model").style.width = "0%";
            window.document.getElementById("Lang_GPS_Distance").style.display = "table-cell";
            window.document.getElementById("Lang_GPS_Distance").style.width = "auto";
        }
        function delBegtime() {
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr id="derppp">
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul" id="userul2" runat="server">
                                        <li>
                                            <img src="../images/311.gif" width="16" height="16" /><span id="Lang_GPSList">控制列表</span></li>

                                    </ul>
                                </td>
                                <td width="50" background="../images/tab_05.gif" align="right">
                                    <img style="cursor: pointer;" onclick="window.parent.mycallfunction('SearchGpsStatues',693, 702)"
                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="dragtd">
                            <tr>
                                <td width="15" background="../images/tab_12.gif">&nbsp;
                                </td>
                                <td align="center" valign="top" style="height:350px; background-color: white" >

                                    <table cellspacing="1" cellpadding="0" id="GridView1" style="background-color: #C0DE98; border-color: White; border-width: 0px; border-style: Ridge; width: 99%; height:auto;">
                                        <tr style="color: blue; background-color: White; height: 28px;">
                                            <th style="font-family: Arial" scope="col" colspan="8" align="right">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td align="left" colspan="2">
                                                                    <select id="selFunc" onchange="selfunOnChange()" class="">
                                                                        ...
                                                                        <option id="Lang_GPS_Control" value="1"></option>
                                                ...
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 45%">
                                                            <input type="button" id="btn_Open" class="button-blue" onclick="openclick()" />&nbsp;&nbsp;
                                                <%--<input type="button" id="btn_Param" onclick="paramclick()" />--%>
                                                        ...
                                                        <td align="right" style="width: 20%">
                                                            ...
                                                            <span id="span_currentact">0~0</span>/<span id="span_total">0</span><span id="span_Article"></span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                                        ...
                                        <tr class="gridheadcss" style="font-weight: bold;">
                                            ...
                                            <th style="width: 12%" id="Lang_terminal_identification" scope="col">TerminalID</th>
                                            <th style="width: 12%" id="Lang_Name" scope="col">用户名称</th>
                                            <th style="width: 12%" id="Lang_Operatetime" scope="col">操作时间</th>
                                            <th style="width: 12%" id="Lang_GPSSwitch2" scope="col">GPS开关</th>
                                            <th style="width: 12%" id="tdcpscritical"  scope="col"><span id="Lang_GPSCritical2">上报周期</span>(s)</th>
                                            <th style="width: 12%" id="Lang_GPSDest2" scope="col">上报目的</th>
                                            <%--<th style="width: 12%" id="Lang_GPS_Model" scope="col">上报模式</th>--%>
                                             <th style="width: 12%;display:table-cell" id="Lang_GPS_Distance" scope="col">距离上报</th>
                                        </tr>
...
<script>    window.parent.closeprossdiv(); searchList();
    ...
    window.document.getElementById("opSuccess").text = Success;
    window.document.getElementById("opFailed").text = Failed;
    window.document.getElementById("opUnknow").text = Unkown;
    ...
    window.document.getElementById("btn_Open").value = window.parent.GetTextByName("Lang_GPS_Control", window.parent.useprameters.languagedata);
    ...
    window.document.getElementById("Lang_GPSSwitch2").innerHTML = window.parent.parent.GetTextByName("Lang_GPS_Control", window.parent.parent.useprameters.languagedata);
    ...
    window.document.getElementById("Lang_GPSCritical2").innerHTML = window.parent.parent.GetTextByName("Lang_GPSCritical", window.parent.parent.useprameters.languagedata);
   ...
   {%>
    ...
    var dragEnable = 'True';
    function dragdiv() {
        var div1 = window.parent.document.getElementById('SearchGpsStatues');
