<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="realTimeTraceUserList.aspx.cs" Inherits="Web.lqnew.opePages.realTimeTraceUserList" %>
...
<body style="height:450px" class="bodycss">
    ...
    <div id="realTimeTraceWindow" style="position:absolute;">
                    ...
                    <table id="headtable" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:20px">
                            ...
                            <td width="281" background="../images/tab_05.gif" align="right">
                                <img class="style6" style="cursor: pointer;" onclick="closeRealTimeTraceUserlists();" onmouseover="javascript:this.src='../images/close_un.png';" onmouseout="javascript:this.src='../images/close.png';" src="../images/close.png" /></td>
                            <td width="14">
                             ...
                             <table  cellspacing="1">
                                ...
                                <div id="policewindow">
                                    <div id="search" style="display: none;">
                                        ...
                                        <input id="Lang_searchinresult" type="button" style="margin-left: 1px" value="<%--在结果中搜索--%>" title="<%--在框选结果中搜索--%>" onclick="searchinresult()" />                         
                                        <input id="Lang_searchlockuser" type="button" style="margin-left: 1px" value="<%--搜索锁定用户--%>" title="<%--搜索锁定用户--%>" onclick="searchlockuser()" />
                                    </div>
     ...
     <script type="text/javascript">
         ...
         var dragEnable = 'True';
         function dragdiv() {
             var div1 = window.parent.document.getElementById("realTimeTraceUserList");
         ...
         window.onload = function () {
             Allpolices = eval('<%=allRealTimeTraceUsers_json%>');
             eachpagenum = 30;
             paintpolices = Allpolices;
             paintpolicestable();
             displayorhidesearchlockuserdiv();
             //给搜索输入框添加内容改变事件
             //addEvent改为addEventListener---------------------------------xzj--2018/4/25-----------------------------------------------------
         ...
         function createpagetables() {
             try {
                 ...
                 if (pagenum != pageselect.childNodes.length) {
         ...
         function closeRealTimeTraceUserlists() {
             window.parent.hiddenbg2();
             window.parent.mycallfunction(geturl(), 600, 450);
         }
    </script>
</body>
<script type="text/javascript">
