<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_DXGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.manager_DXGroup" %>
                            ...
                            <tr>
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul" id="userul" runat="server">
                                        <li>
                                            <img src="../images/311.gif" width="16" height="16" /><span id="Lang-T-DXGroupInfoTable"></span></li>
                                        <li>
                                        ...
                                        <li><span id="Lang-T-DXGroupName"></span><span>&nbsp;&nbsp;</span><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></li>
                                        <li>
                                        ...
                                        <li>
                                            <img id="Lang_AddNew" class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('add_DXGroup',494,445,'&CMD=DXADD')"
                                ...
                                <td width="50" background="../images/tab_05.gif" align="right">
                                    <img class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('manager_DXGroup',654,354)"
                                ...
                                <td align="center" id="dragtd">
                                    <asp:GridView ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('view_info/view_DXgroup',468, 342,'<%#Eval("id") %>')"
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('edit_DXGroup',494,445,'<%#Eval("id") %>&GSSI=<%#Eval("Group_index") %>')"
                                                        style="cursor: hand;">
