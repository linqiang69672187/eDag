<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grouptreeResPermission.aspx.cs" Inherits="Web.lqnew.opePages.grouptreeResPermission" %>
        ...
        <script type="text/javascript">
            ...
            function getentitytree() {
                ...
                $.ajax({
                    ...
                    data: { "loginUserId": +Cookies.get("loginUserId"), "dispatchGroup": "group" },
                                    ...
                                    onClick: function (node) {
                                        displayGrouplists();
                                            ...
                                            if (node.type == "zhishu") {
                                                ...
                                                window.parent.parent.parent.frames["grouplists"].getGroup(entityId, entityName, clickItemType);
            ...
            {
                window.parent.parent.parent.document.getElementById("grouplistsdiv").style.display = "block";
                window.parent.parent.parent.document.getElementById("dispatchlistsdiv").style.display = "none";
