<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dispatchlists.aspx.cs" Inherits="Web.lqnew.opePages.dispatchlists" %>
            ...
            <div id="policewindow">
                ...
                <div id="policetitlediv" style="width: 99%; margin-top: 2px; margin-left: 1px; text-align: center; display: none;">
                    <table cellspacing="1" cellpadding="0" id="GridView1" style="background-color: #C0DE98; border-color: White; border-width: 0px; border-style: Ridge; width: 307px;">
                        <tr class="gridheadcss" style="font-weight: bold;">
                            <%--<th id="Lang_name" style="width: 50px"></th>  --%>
                            <th id="Lang_Schedulinguseid" style="width: 49px"><%--调度用户标识--%></th>
                ...
                <script type="text/javascript">
                    ...
                    function createpolicetable_ajax(type, value, clickItemType) {
                        jquerygetNewData_ajax("dispatchlistdata.aspx", { type: type, value: value, clickItemType: clickItemType }, function (msg) {
                            try {
                                //processbar
                                Hideprocessbar();
                    ...
                    function creatpolicetable() {
                        try {
                            ...
                            for (var i = 0; i < trnum; i++) {
                                ...
                                policetd_ISSI.innerHTML = Allpolices[i + indexstep].DISSI;
                                policetd_ISSI.CI=Allpolices[i + indexstep].id;
                                policetd_ISSI.style.width = "49px";
                                policetd_ISSI.style.textAlign = "center";
                                policetd_ISSI.style.cursor = "hand";
                                policetd_ISSI.onclick = function () {
                                    window.parent.CreatedivORnewopen("view_info/view_dispatich",this.CI,"600","200");
                                }
                                ...
                                policetd_operate.CI = Allpolices[i + indexstep].DISSI;

                                policetd_operate.style.width = "45px";
                                if (Allpolices[i + indexstep].DISSI != "") {
                                    policetd_operate.innerHTML = "<img src='../img/treebutton2.gif'/>";
                                    policetd_operate.onclick = function () {
                                        setrightvalue(this.CI, "group");
                                        
                                        //MouseMenu_onclick(window.parent, "dispatchmouseMenu");
                                        var obj = window.parent
                                        var mainSWF = obj.document.getElementById("main");
                                        if (mainSWF) {
                                            mainSWF.webRightClickHandler_Groupdp("dispatch", this.CI, event.screenX + 75, event.screenY - 122);
                                        }
                                    }
                                }
                    ...
                    function hidegrouplistsdiv() {
                        var grouplists_div = window.parent.document.getElementById("dispatchlistsdiv");
                        if (grouplists_div) {
