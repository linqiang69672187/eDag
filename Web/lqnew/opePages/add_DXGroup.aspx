<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false" CodeBehind="add_DXGroup.aspx.cs" Inherits="Web.lqnew.opePages.add_DXGroup" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function OnClose() {
            ...
            window.parent.mycallfunction('add_DXGroup');
        }
    </script>
</head>
<body>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="281" background="../images/tab_05.gif" align="right">
                                <img style="cursor: hand;" onclick="OnClose()"
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="center"  id="dragtd">
                                <table class="style1" cellspacing="1">
                                        ...
                                        <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png);
                                            ...
                                            <div style="background-image: url(../images/add_entity_info.png); width: 109px; height: 23px;">
                                                <div style="margin-left: 27px; font-size: 14px; font-weight: bold; color: #006633;
                                                    padding-top: 5px;">
                                                    <asp:Label ID="labTitle" Font-Size="14px" ForeColor="#006633" runat="server"></asp:Label></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="style3" align="left">
                                            ...
                                            <asp:RegularExpressionValidator ValidationGroup="vgsumit" ID="validateEntityLength" runat="server" Display="None"
                                    ...
                                    <%if (Request["CMD"].ToString() == "CALLPANL" || Request["CMD"].ToString() == "DXCALLPANL") { }
                                      else
                                      { %>
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td align="center" height="30">
                                ...
                                <img   id="Lang-Cancel"   style="cursor: pointer;" onclick="OnClose()"
                                    />
                                <!---------------------------xzj--2018/6/28--将imgid改为id,cursor属性值改为pointer------------------>
                            </td>
                            <td width="14" background="../images/tab_16.gif">
