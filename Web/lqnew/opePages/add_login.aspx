<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="add_login.aspx.cs" Inherits="Web.lqnew.opePages.add_login" %>
                                    ...
                                    <table class="style1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="style3">
                                                ...
                                                <asp:ObjectDataSource ID="DataSourceRole" runat="server" SelectMethod="GetAllRoleInfo"
                                                    TypeName="DbComponent.Entity"></asp:ObjectDataSource>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style3" align="right" style="width: 90px;">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:RadioButtonList ID="voiceType" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="1" Selected="True">TETRA</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ControlToValidate="TextBox1" ValidationExpression="^[a-zA-Z]\w{3,11}$" ID="regExpVali1" 
                                                    runat="server" Display="None" ErrorMessage="RegularExpressionValidator"></asp:RegularExpressionValidator>
                                                <cc1:ValidatorCalloutExtender ID="Validatorcalloutextender3" runat="server" TargetControlID="regExpVali1"
                                                    Width="210px" HighlightCssClass="cssValidatorCalloutHighlight">
                                                    <Animations>  
                                                <OnShow>
                                                    <Sequence>
