<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit_TBGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.edit_TBGroup" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table class="style1" cellspacing="1" id="dragtd">
                                            ...
                                            <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png); height: 33;">
                                                <div style="background-image: url(../images/add_entity_info.png); width: 130px; height: 23px;">
                                                    <div style="margin-left: 28px; font-size: 14px; font-weight: bold; color: #006633; padding-top: 5px;">
                                                        <span class="Langtxt" id="multicastgroupinformation"></span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style3" align="right" style="width: 75px;">
                                                <span class="Langtxt" id="multicastgroupname"></span>&nbsp;&nbsp;
                                            </td>
                                            <td class="style3" align="left">
                                                <asp:TextBox ValidationGroup="sub1" ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                                <font color="red">*</font>
                                        ...
                                        <tr>
                                            <td class="style3" align="right">
                                                <span class="Langtxt" id="Lang_TBGroupType"></span>&nbsp;&nbsp;
                                            </td>
                                            <td class="style3" align="left">
                                                <asp:Label ID="tbgrouptype" runat="server" CssClass="style3"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style3" align="right">
                                                <span class="Langtxt" id="TBgroupNumber"></span>&nbsp;&nbsp;
                                            </td>
                                            <td class="style3" align="left">
                                                <asp:TextBox ID="TextBox4" ReadOnly="true" ValidationGroup="sub1" runat="server" Width="120px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                             <td class="style3" align="right">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td background="images/tab_05.gif">
                                                                                <ul class="hor_ul">
                                                                                    <li>
                                                                                        <asp:DropDownList ValidationGroup="sub2" ID="DropDownList3" runat="server" AppendDataBoundItems="True" DataSourceID="ObjectDataSource2"
                                                                                    ...
                                                                                    <li>
                                                                                        <asp:DropDownList ValidationGroup="sub2" ID="DropDownList4" runat="server">
                                                                                            <asp:ListItem Value="Group_name"></asp:ListItem>
                                                                                            <asp:ListItem Value="GSSI"></asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </li>
                                                                                    <li>
                                                                                        <asp:TextBox ValidationGroup="sub2" ID="TextBox2" runat="server" Width="65px"></asp:TextBox></li>
                                                                                    <li>
                                                                                        <asp:ImageButton ValidationGroup="sub2" ID="ImageButton6" runat="server"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td bgcolor="#f3ffe3">
                                                                                <asp:UpdateProgress AssociatedUpdatePanelID="UpdatePanel1" ID="UpdateProgress1" runat="server">
                                                                                    <ProgressTemplate>
                                                                                        <img src="../../Images/ProgressBar/05043123.gif" /><span class="Langtxt" id="Lang_loading"></span>....
                                                                                    </ProgressTemplate>
                                                                                </asp:UpdateProgress>
                                                                                <asp:GridView ValidationGroup="sub2" ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    BorderColor="White" BorderStyle="Ridge" AllowPaging="True" AllowSorting="false"
                                                                                ...
                                                                                <asp:DropDownList ID="DropDownList5" runat="server" Height="16px" OnTextChanged="DropDownList5_TextChanged"
                                                                                    Visible="false">
                                                                                    <asp:ListItem Value="0"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" SortParameterName="sort"
                                                                                    SelectCountMethod="CountcheckTBgroup_GSSISByStrProc" SelectMethod="checkTBgroup_GSSISByStrProc"
                                                                                    TypeName="DbComponent.group">
                                                                                    <SelectParameters>
                                                                                        ...
                                                                                        <asp:QueryStringParameter Name="GSSI" QueryStringField="GSSI" DefaultValue="0" />
                                                                                        <asp:CookieParameter CookieName="id" Name="id" Type="Int32" />
                                                                                    </SelectParameters>
                                                                                </asp:ObjectDataSource>
                                                                            </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td background="images/tab_21.gif">
                                                                                <asp:Label ID="Label2" runat="server" OnLoad="Label2_Load" OnUnload="Label2_Unload"><img src="../images/viewinfo_bg.png" /><span class="Langtxt" id="MMembersgroup" ></span>…</asp:Label>
                                                                            </td>
                                                                            <td width="14">
                                        ...
                                        <tr style="display: none">
                                            ...
                                            <td align="left">
                                                <asp:RadioButtonList ValidationGroup="sub1" ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                            ...
                            <tr>
                                ...
                                <td align="center" height="30">
                                    <asp:ImageButton ID="ImageButton1" ValidationGroup="sub1" runat="server"
