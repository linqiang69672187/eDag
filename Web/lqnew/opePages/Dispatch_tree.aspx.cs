...
{
    public partial class Dispatch_tree : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DbComponent.Tree myissitree = new DbComponent.Tree(Request.Cookies["id"].Value, new string[] { ResourceManager.GetString("Dispatch") }, ResourceManager.GetString("Dispatch"), Request.Cookies["username"].Value);
