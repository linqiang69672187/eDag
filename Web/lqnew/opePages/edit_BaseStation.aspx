<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit_BaseStation.aspx.cs"
    Inherits="Web.lqnew.opePages.edit_BaseStation" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center">
                                    <table class="style1" cellspacing="1" id="dragtd">
                                        <tr>
                                            <td colspan="2" align="left" style="background-image: url(../images/add_entity_infobg.png); height: 33;">
                                                <div style="background-image: url(../images/add_entity_info.png); width: 109px; height: 23px;">
                                                    <div style="margin-left: 41px; font-size: 14px; font-weight: bold; color: #006633; padding-top: 5px;">
                                                        <span class="Langtxt" id="stationinformation"></span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td id="Langue-BaseStationName" class="style3" align="right" style="width: 90px;">
                                            ...
                                            <td align="left" class="style3">
                                                ...
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender10" runat="server" TargetControlID="validateEntityLength"
                                                    Width="150px" HighlightCssClass="cssValidatorCalloutHighlight">
                                                    <Animations>
                                                <OnShow>
                                                    <Sequence>
                                                ...
                                                <cc1:ValidatorCalloutExtender ID="Validatorcalloutextender3" runat="server" TargetControlID="rfvBaseStationName" Width="150" HighlightCssClass="cssValidatorCalloutHighlight">
                                                    <Animations>
                                                <OnShow>
                                                    <Sequence>
                                                        <HideAction Visible="true" />
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="style3">
                                                <asp:TextBox ID="txtBaseISSI" runat="server" Width="150px"></asp:TextBox><font color="red">*</font>
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvBaseStationISSI" runat="server" ControlToValidate="txtBaseISSI"
                                                    Display="None"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="Validatorcalloutextender4" runat="server" TargetControlID="rfvBaseStationISSI" Width="150" HighlightCssClass="cssValidatorCalloutHighlight">
                                                    <Animations>
                                                <OnShow>
                                                    <Sequence>
                                                        <HideAction Visible="true" />
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="style3">
                                                <div onclick="window.parent.GetJWD()">
                                                    ...
                                                    <span class="Langtxt" id="Lang-Click"></span><font id="Lang_Get" class="Langtxt" style="cursor: pointer" color="blue"></font><span class="Langtxt" id="Lang_Sit"></span>
                                                    <!---------xzj--2018/6/29---------将cursor属性值改为pointer-->
                                                </div>
                                                <div id="divstatue">
                                                </div>
                            ...
                            <tr>
                                ...
                                <td align="center" height="30">
                                    ...
                                    <!---------------------------xzj--2018/6/28--注释原来的,去掉onclick中CloseJWD()函数,id改为cancel1------------------>
                                    <!--<img style="cursor: pointer;" onclick="window.parent.CloseJWD();window.parent.mycallfunction(geturl())"
                                    id="cancel1" runat="server" />-->
                                    <img style="cursor: pointer;" onclick="window.parent.mycallfunction(geturl())"
                                    id="cancel" runat="server" />
                                    <!---------------------------xzj--2018/6/28--注释原来的,去掉onclick中CloseJWD()函数------------------>
                                </td>
                                <td width="14" background="../images/tab_16.gif">&nbsp;
                                </td>
                            </tr>
