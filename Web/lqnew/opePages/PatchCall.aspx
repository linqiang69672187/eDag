<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatchCall.aspx.cs" Inherits="Web.lqnew.opePages.PatchCall" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CloseWindow() {
            ...
            window.parent.mycallfunction('PatchCall');
        }
        function PTTGCALL() {
            alert(userids);
        }
        ...
        $(document).ready(function () {
            ...
            $("#imgSelectUser").click(function () {
                ...
                window.parent.mycallfunction('Add_StackMember/add_Member', 635, 514, userids + "&ifr=PatchCall_ifr", 2001);
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../images/tab_05.gif">
                                <ul class="hor_ul">
                                    <li>
                                        <img src="../images/037.gif" />派接组呼叫</li>
                                </ul>
                            </td>
