<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  CodeBehind="SendGPSEnableOrDisableRequest.aspx.cs"
    Inherits="Web.lqnew.opePages.SendGPSEnableOrDisableRequest" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function faterdo(retrunissis) {
            $("#txtISSIText").val(retrunissis);
            $.ajax({
                type: "POST",
                url: "../../Handlers/GetUserInfo_Handler.ashx",
                data: "issi=" + retrunissis,
                success: function (msg) {
