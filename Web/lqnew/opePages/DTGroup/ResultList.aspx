<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultList.aspx.cs" Inherits="Web.lqnew.opePages.DTGroup.ResultList" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function toHTML(totalcount, havedocount, dotype, gssi, cjarry, sbarry) {
            ...
            if (dotype == "add") {
                strtitle +=LangAddDTMemberTODTGroup+ "(" + gssi + ")<br>";
            } else {
                strtitle += LangDelDtMemberFromDTGroup+"(" + gssi + ")<br>";
            }
            ...
            if (totalcount == havedocount || document.getElementById("divClose").style.display != "none") {
                //document.getElementById("resultContent").innerHTML += "<br>" + LangThisRWHaveOver;
                document.getElementById("qxzx").style.display = "none";
                //var sblist = "";
                //for (var p = 0; p < sbarry.length; p++) {
                //    sblist += "<br>" + sbarry[p];
                //}
                //if (document.getElementById("span_sb")) {
                   
                //    document.getElementById("span_sb").title = sblist;
                //}
            }
            else {
        ...
        window.onload = function () {
            ...
            document.onmousedown = function () {
                var div1 = window.parent.document.getElementById('DTGroup/ResultList');
        ...
        function closethispage() {
            ...
            window.parent.lq_closeANDremovediv('DTGroup/ResultList', 'bgDiv');
        }
