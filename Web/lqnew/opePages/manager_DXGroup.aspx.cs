...
{
    public partial class manager_DXGroup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GridView1.Columns[0].HeaderText = ResourceManager.GetString("Lang-T-DXGroupNametext");
            ...
            switch (e.CommandName)
            {
                ...
                case "MyDel":
                    if (DXGroupInfo.GetDxGroupByID(ID) == null) {
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>alert('" + ResourceManager.GetString("Delfailmanager_DXgroup") + "');</script>");
                        return;
                    }
                    ...
                    if (!DXGroupInfo.SelectStatusByID(ID))
                    {
                        ...
                        {
                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>window.document.getElementById('Lang_AddNew').src = window.parent.GetTextByName('Lang_AddNew', window.parent.useprameters.languagedata);alert('" + ResourceManager.GetString("OperationSuccessful") + "');window.parent.lq_changeifr('manager_DXGroup');</script>");
                        }
                        else
                        {
