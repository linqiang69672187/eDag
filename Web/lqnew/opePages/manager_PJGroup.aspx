<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_PJGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.manager_PJGroup" %>
                            ...
                            <tr>
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul" id="userul" runat="server">
                                        <li>
                                            <img src="../images/311.gif" width="16" height="16" /><span id="Lang-T-PJGroupInfoTable"></span></li>
                                        <li>
                                        ...
                                        <li><span id="Lang-T-PJGroupName"></span><span>&nbsp;&nbsp;</span><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></li>
                                        <li>
                                        ...
                                        <li>
                                            <img id="Lang_AddNew" class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('add_DXGroup',494,445,'&CMD=PJADD')"
                                ...
                                <td width="50" background="../images/tab_05.gif" align="right">
                                    <img class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('manager_PJGroup',654,354)"
                            ...
                            <tr>
                                ...
                                <td align="center" id="dragtd">
                                    <asp:GridView ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"
                                        ...
                                        DataKeyNames="id,GSSIS">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('view_info/view_PJgroup',468, 342,'<%#Eval("id") %>')"
                                                        style="cursor: hand;">&nbsp;&nbsp;<%# Eval("Group_name")%></font>
                                                    <%--<font style="cursor: hand;">&nbsp;&nbsp;<%# Eval("Group_name")%></font>--%>
                                                </ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="status" Visible="false" HeaderText="">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('edit_PJGroup',494,445,'<%#Eval("id") %>&GSSI=<%#Eval("Group_index") %>')"
                                                        style="cursor: hand;">
                                                        <img id="img_modify" runat="server" src="../images/114.gif" /></font>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="ImageButton2" CommandName="MyDel" CommandArgument='<%# Eval("id") %>'
                                                        runat="server"><img id="img_del" runat="server" src="images/083.gif"  /></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                                            </asp:TemplateField>
                                        </Columns>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" valign="top" class="STYLE1">
                                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" SortParameterName="sort"
                                                    SelectCountMethod="getallGroupcount" SelectMethod="AllGroupInfo" TypeName="DbComponent.DXGroupInfoDao">
                                                    <SelectParameters>
                                                        ...
                                                        <asp:Parameter DefaultValue="1" Name="gtype" Type="Int32" />
                                                    </SelectParameters>
                                                </asp:ObjectDataSource>
                                            </td>
                                        </tr>
