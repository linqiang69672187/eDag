...
<head id="Head1" runat="server">
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <script type="text/javascript">
        ...
        var Lang_UnPullUp_Success = window.parent.GetTextByName("PullUp_unactive_sucess", window.parent.useprameters.languagedata);
        var Lang_UnPullUp_Failed = window.parent.GetTextByName("PullUp_unactive_fail", window.parent.useprameters.languagedata);
        var Lang_UnPullUp_Unkown = window.parent.GetTextByName("PullUp_unactive_unknown", window.parent.useprameters.languagedata);
        ...
        function toHTML(totalcount, havedocount, openorclose, cjarry, sbarry, cgwgarray, cgUnPullUparray, sbUnPullUparray) {
            //alert(openorclose);
            if (totalcount == sbarry.length + cjarry.length || totalcount == cgUnPullUparray.length + sbUnPullUparray.length || totalcount == cgUnPullUparray.length || totalcount == sbUnPullUparray.length) {
                if (openorclose == 1) {
                    for (var i = 0; i < cjarry.length; i++) {
                        document.getElementById("GPSPullDetailInfo").innerHTML += cjarry[i] + "<br>";
                    }

                    for (var i = 0; i < sbarry.length; i++) {
                        //var detail = sbarry[i].toString().split(',');
                        document.getElementById("GPSPullDetailInfo").innerHTML += sbarry[i].toString() + "<br>";
                    }

                    for (var i = 0; i < cgwgarray.length; i++) {
                        document.getElementById("GPSPullDetailInfo").innerHTML += cgwgarray[i] + "<br>";
                    }
                }
                if (openorclose == 2) {
                    alert(openorclose);
                    document.getElementById("GPSPullDetailInfo1").innerHTML == "";
                }
                for (var i = 0; i < cgUnPullUparray.length; i++) {
                    document.getElementById("GPSPullDetailInfo1").innerHTML += cgUnPullUparray[i] + "<br>";
                }

                for (var i = 0; i < sbUnPullUparray.length; i++) {
                    document.getElementById("GPSPullDetailInfo1").innerHTML += sbUnPullUparray[i] + "<br>";
                }
            }
            ...
            var cgUncount = cgUnPullUparray.length;
            var sbUncount = sbUnPullUparray.length;
            var strtitle = window.parent.GetTextByName("PullUp_active", window.parent.useprameters.languagedata);
            var strtitle1 = window.parent.GetTextByName("PullUp_unactive", window.parent.useprameters.languagedata);
            var wcgs = "";
            var otherstr = "";
            var otherUnstr = "";
            ...
            var wzUnarraycount = totalcount - parseFloat(cgUncount) - parseFloat(sbUncount);
            ...
            //otherUnstr += LangRemainDoingTime + ":" + (parseFloat(totalcount) - parseFloat(havedocount)) * thisSendTDGFlashTime + "S";
            otherUnstr += "<br><br><br><br>" + Lang_UnPullUp_Success + ":" + cgUncount;
            otherUnstr += "   " + LangHaveDoingSUCEESSPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(cgUncount) / parseFloat(totalcount))) * 100) + "%";
            otherUnstr += "<br>" + Lang_UnPullUp_Failed + ":<span id='span_Unsb'>" + sbUncount + "</span>";
            otherUnstr += "   " + LangHaveDoingFailedPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(sbUncount) / parseFloat(totalcount))) * 100) + "%";
            otherUnstr += "<br>" + Lang_UnPullUp_Unkown + ":" + wzUnarraycount;
            otherUnstr += "   " + LangUnKnownPercent + ":" + changeTwoDecimal((parseFloat(parseFloat(wzUnarraycount) / parseFloat(totalcount))) * 100) + "%";


            document.getElementById("divtitle1").innerHTML = strtitle1;
            document.getElementById("wcgs").innerHTML = wcgs;
            //document.getElementById("wcgs1").innerHTML = wcgs;
            ...
            document.getElementById("resultUnContent").innerHTML = otherUnstr;
        ...
        window.onload = function () {
            ...
            var table1 = document.getElementById("dragtd1");
            table1.onmouseout = function () {
                dragEnable = 'True';
            }
    ...
    <form id="form1" runat="server">
        ...
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;" id="derppp">
                ...
                <td background="../../images/tab_05.gif" colspan="2">
                    <ul class="hor_ul" id="userul2" runat="server">
                         <li><img src="../images/311.gif" width="16" height="16" /><span id="detailInfo">详细信息</span></li>
                    </ul>
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd1">
                    <div style="width: 400px; height: 150px">
                        <div><b id="divtitle1"></b></div>
                        <div id="resultUnContent"></div>
                    </div>
                </td>
            ...
            <tr style="height: 15px;">
                ...
                <td  class="bg4">
                    <div id="GPSPullDetailInfo1" style="height:100px;overflow:auto;"></div>
                </td>
                <td width="14" background="../../images/tab_16.gif">&nbsp;
                </td>
            </tr>
            <tr style="height: 15px;">
                ...
                <td background="../../images/tab_21.gif" colspan="2"></td>
                <td>
...
<script>
    ...
    document.getElementById("detailInfo").innerHTML = window.parent.GetTextByName("Info", window.parent.useprameters.languagedata);
