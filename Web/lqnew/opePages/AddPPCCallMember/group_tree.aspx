<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPPCCallMember.group_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var Group = window.parent.parent.parent.GetTextByName("Group", window.parent.parent.parent.useprameters.languagedata);
