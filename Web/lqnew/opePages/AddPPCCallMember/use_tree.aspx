<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="use_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPPCCallMember.use_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var police = window.parent.parent.parent.GetTextByName("police", window.parent.parent.parent.useprameters.languagedata);
