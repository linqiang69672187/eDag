<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_Member.aspx.cs" Inherits="Web.lqnew.opePages.AddPPCCallMember.add_Member" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title><span id="Lang_recieve_number"></span><%--接收号码--%></title>
    <style type="text/css">
        body, .style1
        {
    ...
    <script language="javascript">
        ...
        function Insertissi() {
            //验证issi是否为数字
            var Lang_ISSI_nember_is_1to80699999 = window.parent.parent.GetTextByName("Lang_ISSI_nember_is_1to80699999", window.parent.parent.useprameters.languagedata);
        ...
        function sendok() {
            ...
            if (sendMsgwindo) {
                ...
                window.parent.lq_closeANDremovediv('AddPPCCallMember/add_Member', 'bgDiv');
            }
        }
        var dragEnable = 'True';
        function dragdiv() {
            var div1 = window.parent.document.getElementById('AddPPCCallMember/add_Member');
    ...
    <form id="form1" runat="server">
        ...
        <table class="style1" cellpadding="0" cellspacing="0">
            <tr style="height: 5px;">
                ...
                <td class="bg1">
                    <div id="divClose" style="display: none" onmouseover="Divover('on')" onclick="window.parent.lq_closeANDremovediv('AddPPCCallMember/add_Member','bgDiv')" onmouseout="Divover('out')"></div>
                </td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="bg4" id="dragtd">
                    <table cellpadding="0" cellspacing="0" class="style3">
                                                                                ...
                                                                                <div class="divgrd" id="tbtbz">
                                                                                    <table cellspacing="1" cellpadding="0" style="background-color: #C0DE98; border-color: White; border-width: 0px; border-style: Ridge; width: 99%;">
                                                                                        ...
                                                                                        <tr class="gridheadcss" style="font-weight: bold; font-size: 12px;">
                                                                                            <th scope="col"><span id="Lang_Unit"></span><%--单位--%></th>
                                                                                            <th scope="col" style="white-space: nowrap; width: 40px;"><span id="Lang_Type"></span></th>
                                                                                            <th scope="col" style="white-space: nowrap; width: 60px;">ISSI/GSSI</th>
                                                                                            <th scope="col" style="white-space: nowrap; width: 60px;"><span id="Lang_name"></span><%--姓名--%></th>
                      ...
                      <img id="cancelbutton" style="margin-top: 3px; cursor: hand; display: none" src="<%--../../images/add_cancel.png--%>" onclick="window.parent.lq_closeANDremovediv('AddPPCCallMember/add_Member','bgDiv')" /></td>
                        </tr>
                    </table>
