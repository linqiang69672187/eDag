<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mian_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPPCCallMember.mian_tree" %>
    ...
    <form id="form1" style="height: 425;" runat="server">
        <div style="height: 425;">
            ...
            <ul class="tabs" style="margin: 0px; display: none;" id="tabsid">
                <li><a href="#"><span id="Lang_police"></span><%--警员--%><span>/</span></a></li>
                <li><a href="#"><span id="Lang_Terminal"></span><%--终端--%><span>/</span></a></li>
                <li><a href="#"><span id="Lang_Group"></span><%--编组--%><span>/</span></a></li>
                <li><a href="#"><span id="Lang_Dispatch"></span><%--调度台--%></a></li>
            </ul>
            <!-- tab "panes" -->
            <div class="panes">
                <div>
