<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dispatch_tree.aspx.cs" Inherits="Web.lqnew.opePages.AddPPCCallMember.dispatch_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var Dispatch = window.parent.parent.parent.GetTextByName("Dispatch", window.parent.parent.parent.useprameters.languagedata);
