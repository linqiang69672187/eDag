<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_TBGroup.aspx.cs"
    Inherits="Web.lqnew.opePages.manager_TBGroup" %>
                            ...
                            <tr>
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul" id="userul" runat="server">
                                        <li>
                                            <img src="../images/311.gif" width="16" height="16" /><span id="Lang-T-TBGroupInfoTable"></span></li>
                                        <li>
                                        ...
                                        <li><span id="Lang-T-TBGroupName"></span><span>&nbsp;&nbsp;</span><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></li>
                                        <li>
                                        ...
                                        <li>
                                            <!---------------------------xzj--2018/6/28--将cursor属性值改为pointer,onclick中函数的参数改为455------------------>
                                            <img id="Lang_AddNew" class="style6" style="cursor: pointer;" onclick="window.parent.mycallfunction('add_TBGroup',494,460)"
                                ...
                                <td width="50" background="../images/tab_05.gif" align="right">
                                    <img class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('manager_TBGroup',654,354)"
                                ...
                                <td align="center" id="dragtd">
                                    <asp:GridView ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('view_info/view_TBgroup',468, 342,'<%#Eval("id") %>')"
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('edit_TBGroup',494,465,'<%#Eval("id") %>&GSSI=<%#Eval("GSSI") %>')"
                                                        style="cursor: hand;">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="ImageButton2" CommandName="MyDel" CommandArgument='<%# Eval("id") %>'
                                                        runat="server">
                                                        <img id="img_del" runat="server" src="images/083.gif" /><%--<font  Class='Lang' langid='Lang-T-add' color='black'></font>--%>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                                            </asp:TemplateField>
