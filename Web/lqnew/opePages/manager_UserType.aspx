<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_UserType.aspx.cs"
    Inherits="Web.lqnew.opePages.manager_UserType" %>
                            ...
                            <tr>
                                ...
                                <td width="1101" background="../images/tab_05.gif">
                                    <ul class="hor_ul" id="userul" runat="server">
                                        <li>
                                            <img src="../images/311.gif" width="16" height="16" /><span class="Langtxt" id="Usertype"></span></li>
                                        <li>
                                            <img id="Lang_AddNew" class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('add_UserType',434, 422)"
                                ...
                                <td width="50" background="../images/tab_05.gif" align="right">
                                    <img class="style6" style="cursor: hand;" onclick="window.parent.mycallfunction('manager_UserType',693, 354)"
                            ...
                            <tr>
                                ...
                                <td align="center" id="dragtd">
                                    <asp:GridView ID="GridView1" runat="server" Width="99%" AutoGenerateColumns="False"
                                        ...
                                        DataKeyNames="ID">
                                        <Columns>
                                            <asp:BoundField DataField="TypeName" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                                ItemStyle-VerticalAlign="Middle">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <%--<asp:BoundField DataField="ImageData">
                             ...
                             ImageUrl='<%# "UpLoad/ReadImage.aspx?name="+ Eval("name")+"&type="+Eval("type") %>'/> 
                                    ...
                                    <ItemStyle HorizontalAlign="Left" /> 
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <font onclick="window.parent.mycallfunction('edit_UserType',434, 445,'<%#Eval("id") %>')"
                                                        style="cursor: hand;">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="ImageButton2" CommandName="MyDel" CommandArgument='<%# Eval("id") %>' runat="server">
                                                        <img id="img_del" runat="server" src="images/083.gif" /><%--<font color="black"><span  class="Langtxt"   id="Delete" ></span></font>--%></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                                            </asp:TemplateField>
                                        </Columns>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" valign="top" class="STYLE1">
                                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" SortParameterName="sort"
                                                    SelectCountMethod="getAllUserTypeCount" SelectMethod="GetAllUserType" TypeName="DbComponent.UserTypeDao">
                                                    <SelectParameters>
                                                    </SelectParameters>
