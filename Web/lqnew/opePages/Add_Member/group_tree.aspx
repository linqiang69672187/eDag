<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_tree.aspx.cs" Inherits="Web.lqnew.opePages.Add_Member.group_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        ...
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(Group) };//"编组"
