...
{
    public partial class edit_PJGroup : BasePage
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    else
                    {
                        ...
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>window.parent.closeprossdiv();alert('" + ResourceManager.GetString("Lang_The_information_of_the_Patch_group_does_not_exist") + "');window.parent.mycallfunction(geturl());</script>");
                    }
                    ...
                    ImageButton6.Attributes.Add("onmouseover", "javascript:this.src='" + ResourceManager.GetString("Lang_Search_un") + "';"); 
                    ImageButton6.Attributes.Add("onmouseout", "javascript:this.src='" + ResourceManager.GetString("Lang_Search") + "';");
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                if (DXGroupInfoService.GetDxGroupByID(int.Parse(Request.QueryString["id"])) == null)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>alert('"+ ResourceManager.GetString("Lang_SelectedUnits")+"');window.parent.mycallfunction('edit_PJGroup');</script>");
                    return;
                }
                ...
                if (err == "")
                {
                    if (DXGroupInfoService.IsExistPjNameByEntityForEdit(Group_name, Entity_ID, int.Parse(Request.QueryString["id"]))) {
                    ...
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "alert", "<script>alert('" + ResourceManager.GetString("Lang_ModifySucc") + "');window.parent.lq_changeifr('manager_PJGroup');window.parent.mycallfunction('edit_PJGroup');</script>");
