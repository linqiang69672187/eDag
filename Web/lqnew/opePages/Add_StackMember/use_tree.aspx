<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="use_tree.aspx.cs" Inherits="Web.lqnew.opePages.Add_StackMember.use_tree" %>
...
<script type="text/javascript">
    ...
    function SelectMember(id, type, treedepth, action) {
        var Person = window.parent.parent.parent.GetTextByName("Person", window.parent.parent.parent.useprameters.languagedata);
        var param = { "id": id, "type": encodeURIComponent(type), "treedepth": treedepth, "url": encodeURIComponent(Person) };//"人员"
