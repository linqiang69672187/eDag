<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_Member.aspx.cs" Inherits="Web.lqnew.opePages.Add_StackMember.add_Member" %>
 ...
 <script language="javascript">
     ...
     function Insertissi() {
         if (document.getElementById("tags").value == "") {
             var Lang_please_input_ISSI_number = window.parent.parent.GetTextByName("Lang_please_input_ISSI_number", window.parent.parent.useprameters.languagedata);
         ...
         if (document.getElementById("tags").value.match(reg) == null || document.getElementById("tags").value < 1 || document.getElementById("tags").value > 80699999) {
             ...
             alert(TerminalNOError);//("ISSI号码为1到80699999");
             return;
         }
     ...
     function sendok() {
         ...
         for (var i = 0; i < tbl.rows.length; i++) {
             if (tbl.rows[i].cells[3].innerHTML == "未知") {
         ...
         if (sendMsgwindo) {
             sendMsgwindo.PickerDo(retrunissis);
             window.parent.lq_closeANDremovediv('Add_StackMember/add_Member', 'bgDiv');
         }
     }
     var dragEnable = 'True';
     function dragdiv() {
         var div1 = window.parent.document.getElementById('Add_StackMember/add_Member');
     ...
     window.onload = function () {
         ...
         var arrayelement = ["input", "a", "select", "li", "font", "img", "textarea"]
         ...
         var param = { "id": Request.QueryString("id") };
         window.parent.parent.parent.jquerygetNewData_ajax("../../../WebGis/Service/getvaluebyuseids.aspx", param, function (request) {
...
<body>
    ...
    <table class="style1" cellpadding="0" cellspacing="0">
        <tr style="height:5px;">
            ...
            <td class="bg1"><div id="divClose" style="display:none" onmouseover="Divover('on')" onclick="window.parent.lq_closeANDremovediv('Add_StackMember/add_Member','bgDiv')" onmouseout="Divover('out')"></div></td>
    ...
    <tr class="gridheadcss" style="font-weight:bold;font-size:12px;">
			<th scope="col" id="Lang_Unit_1" ><%--单位--%></th><th scope="col" style="white-space:nowrap;width:40px;" id="Lang_Type"><%--类型--%></th><th scope="col" style="white-space:nowrap;width:60px;">
            Id</th><th scope="col" style="white-space:nowrap;width:60px;" id="Lang_name_1"><%--姓名--%></th><th scope="col" width="20px">&nbsp;</th>
		</tr>
        <tbody id="GridView1">	
       </tbody>
      </table>
               ...
               <tr>
                 <td colspan="3" align="left" height="35px">
                     <img id="add_okPNG" style="margin-top:3px;cursor:pointer;display:none" src="<%--../../images/edit_entity.png--%>" <%--src="../../images/send_SMS.png"--%> onclick="sendok()" />&nbsp;
                     <img id="cancelbutton" style="margin-top:3px;cursor:pointer;display:none" src="<%--../../images/add_cancel.png--%>" onclick="window.parent.lq_closeANDremovediv('Add_StackMember/add_Member','bgDiv')" /></td>
              </tr>
                </table>
