...
//                    var Pullstatus;
//                    //激活并不是去开启GPS手台开关
//                    window.parent.jquerygetNewData_ajax_pullup("../../Handlers/AddGPSPullParam.ashx", { mtype: "add", srcissi: users[i].uissi, operatetype: "1", expire: totleCycle, period: times, distance: distance, dstissi: dest, gisissi: getCookieByName("dispatchissi"), result: "0", pullstatus: "0" }, function (msg) {
//                        Pullstatus = msg;
//                    });  //将这个上拉的手台初始化到数据库中

//                    if (Pullstatus == '1') {
//                        sbPullUp.push(users[i].uissi + ",其他调度台正在上拉");
//                        writeLog("system", "其他调度台正在上拉" + ":" + users[i].uissi + ";");
//                    } else {
//                        if (dest.trim() == "") {
...
//                    }
//                } catch (ex) {
//                    sbPullUp.push(users[i].uissi + "异常，下发失败");
//                    writeLog("system", Lang_PullUp_ContralFaild + ":" + users[i].uissi + ";");
//                } finally {
//                    toWritePullUpResult(userscount, i); 
//                    if (i < userscount - 1) {
...
//                        }
//                    } else {    //去除激活
//                        window.parent.jquerygetNewData_ajax_pullup("../../Handlers/AddGPSPullParam.ashx", { mtype: "update", srcissi: users[i].uissi, operatetype: "0", expire: totleCycle, period: times, distance: distance, dstissi: dest, gisissi: getCookieByName("dispatchissi"), result: "0", pullstatus: "0" }, function (msg) {
//                            Pullstatus = msg;
//                        });
//                        if (Pullstatus == 1) {
//                            sbPullUp.push(users[i].uissi + ",其他调度台正在上拉");
...
//                    if (retVar == 1 && Pullstatus != 1) { //返回1表示成功下发

//                    } else if (retVar == 0 && Pullstatus != 1) {   //返回0表示下发失败
//                        sbPullUp.push(users[i].uissi + ",下发失败");
//                    } else {

//                    }
//                } catch (ex) {
//                    sbPullUp.push(users[i].uissi + ",下发异常");
//                    writeLog("system", Lang_PullUp_ContralFaild + ":" + users[i].uissi + ";");
//                } finally {
//                    toWritePullUpResult(userscount, i);
//                    if (i < userscount - 1) {
