<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="call_log.aspx.cs" Inherits="Web.lqnew.logwindow.call_log" %>
...
<script type="text/javascript">
    ...
    $("div").smartMenu(mailMenuData, {
        ...
        beforeShow: function () {
            ...
            if (rightselecttype == "group") {
                ...
                //全是正常
                mailMenuData.length = 1;
                mailMenuData[0] = [dispatchcall, dispatchsms];
    ...
    function callfunction(issi) {
        ...
        window.parent.parent.mycallfunction('PrivateCall', 380, 500, '&type=ISSI&myid=' + issi, 1999);
    }
    function callgroupFunction(GSSI) {
        window.parent.parent.mycallfunction('GroupCall', 380, 500, '&type=GSSI&myid=' + GSSI, 1999);
    }
    function calldispatchFunction(issi) {
        window.parent.parent.mycallfunction('PrivateCall', 380, 500, '&type=Dispatch&myid=' + issi, 1999);
    }
</script>
</html>
